...
)
{
    /*
    (k*xh + xl) * (k*yh + yl)
    = k*k*xh*yh + k*(xh*yl + xl*yh) + xl*yl
    */
    GT_U64  z; /* result   */
    GT_U32 xh = x >> 16, xl = x & 0xFFFFU;
    GT_U32 yh = y >> 16, yl = y & 0xFFFFU;
    GT_U32 rl = xl * yl;
    GT_U32 rm1 = xh * yl;
    GT_U32 rm2 = xl * yh;
    GT_U32 rh = xh * yh;
    GT_U32 rm1h = rm1 >> 16, rm1l = rm1 & 0xFFFFU;
    GT_U32 rm2h = rm2 >> 16, rm2l = rm2 & 0xFFFFU;
    GT_U32 rml = rm1l + rm2l;
    GT_U32 rmh = rm1h + rm2h;
