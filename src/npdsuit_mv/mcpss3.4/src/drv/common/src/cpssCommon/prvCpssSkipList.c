...
)
{
    ...
    if (NULL == dataPtr)
    {
        ...
        else
        {
            ...
            *iteratorPtr = (GT_U32)slCtrlPtr->hdrPtr->fwrdArr[0];
    ...
    if (nodePtr->fwrdArr[0] != SL_END)
    {
        ...
        while (nodePtr != SL_END)
        {
            cpssOsPrintf(" %p -> %8p %8p %8p\n",
                     nodePtr, ((GT_U32*)nodePtr->dataPtr)[0],
                     ((GT_U32*)nodePtr->dataPtr)[1],
                     ((GT_U32*)nodePtr->dataPtr)[2]);
