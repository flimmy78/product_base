...
typedef enum
{
    ...
    PRV_CPSS_PHY_EXT_SPEC_CNTRL = 20,/* Extended PHY Specific Control Register */
    ...
    PRV_CPSS_PHY_LED_CNTRL = 24,	 /* LED Control Register */
    PRV_CPSS_FE_PHY_CABLE_DIAG1 = 26,/* FE if Cable Diagnostic Registers for first pair*/
    PRV_CPSS_PHY_EXT_SPEC_CNTRL2 = 26,/* Extended PHY Specific Control 2 Register */
    PRV_CPSS_PHY_EXT_SPEC_STATUS = 27,/* Extended PHY Specific Status Register */
