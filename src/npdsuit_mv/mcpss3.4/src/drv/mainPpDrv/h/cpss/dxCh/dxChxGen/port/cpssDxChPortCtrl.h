...
/*
 * typedef: CPSS_DXCH_PORT_INVALID_CRC_MODE_ENT
 *
 * Description: Bit Per Ingress Port indicating the format of the invalid CRC.
 *
 * Fields:
 *  CPSS_DXCH_PORT_CONTAIN_4B_CRC_MODE_E  
 *			- packets received from port contains 4 bytes of CRC
 *  CPSS_DXCH_PORT_NOT_CONTAIN_4B_CRC_MODE_E - 
 *			- packets received from port DO NOT contain 4 bytes of CRC
*/

typedef enum
{
    CPSS_DXCH_PORT_CONTAIN_4B_CRC_MODE_E = 0,
    CPSS_DXCH_PORT_NOT_CONTAIN_4B_CRC_MODE_E
} CPSS_DXCH_PORT_INVALID_CRC_MODE_ENT;
...
*
* DESCRIPTION:
*       Sets the number of IPG, value is in 8 byte resolution
...
#define XSMI_XMDIO_DELAY_VALUE 0x2
GT_STATUS cpssDxChXsmiAcTimingSet
(
	IN GT_U8	devNum
);

GT_STATUS cpssDxChXGPortIPGSet
(
	IN GT_U8	devNum,
	IN GT_U8	portNum
);
