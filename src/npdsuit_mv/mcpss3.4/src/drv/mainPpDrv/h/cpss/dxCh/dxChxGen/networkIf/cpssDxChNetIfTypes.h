...
typedef enum 
{
	CPSS_OAM_TRAFFIC_TELNET_E = 0,
	CPSS_OAM_TRAFFIC_SSH_E,
	CPSS_OAM_TRAFFIC_HTTP_E,
	CPSS_OAM_TRAFFIC_HTTPS_E,
	CPSS_OAM_TRAFFIC_SNMP_E,
	CPSS_WIRELESS_CAPWAP_CNTL_E,
	CPSS_WIRELESS_CAPWAP_DATA_E,
	CPSS_OAM_TRAFFIC_TYPE_MAX
}CPSS_OAM_TRAFFIC_TYPE_ENT;

/*
  * by qinhs@autelan.com 2008-11-24
  *
  * Description: 
  * 	information about cpu port sdma rx channel mib 
  * (including rx packets/octets and rx error packet per queue)	
  *
  * Fields:
  * 	rxInPkts   - Packets received on this queue since last read
  * 	rxInOctets - Octets received on this queue since last read
  *   resErrCounter - resource errors for received packet at Rx SDMA queue
  */
typedef struct {
    GT_U32    rxInPkts;
    GT_U32    rxInOctets;
    GT_U32    resErrCounter;
}CPSS_DXCH_NET_SDMA_RX_MIB_STC;
