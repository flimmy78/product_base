...
#define PRV_TCAM_MANAGER_NO_MORE_TOKENS_CNS         0xFFFFFFFF
...
*
*******************************************************************************/
static GT_STATUS convertTokenToIndex
(
...
)
{
    ...
    for (i = 1 ; i < tcamManagerPtr->tcamEntries ; i++)
        tcamManagerPtr->tokenToIndexArray[i] = i + 1;
...
)
{
    ...
    if ((tempTcamManager.tcamEntries + 1) > tcamManagerPtr->tokenToIndexArraySize)
    {
        ...
        tcamManagerPtr->tokenToIndexArray[i] = tcamManagerPtr->nextFreeToken;
...
)
{
    ...
    *allocEntryTokenPtr = tcamManagerPtr->nextFreeToken;
    tcamManagerPtr->nextFreeToken = tcamManagerPtr->tokenToIndexArray[tcamManagerPtr->nextFreeToken];
...
)
{
    ...
    tcamManagerPtr->tokenToIndexArray[entryToken] = tcamManagerPtr->nextFreeToken;
