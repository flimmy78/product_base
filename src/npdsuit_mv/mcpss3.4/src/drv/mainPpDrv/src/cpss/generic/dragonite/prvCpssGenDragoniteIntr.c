...
)
{
    ...
    dragoniteIntrScanArray[0].causeRegAddr = (GT_U32)&((PRV_CPSS_DRAGONITE_IRQ_MEMORY_STC*)irqMemPtr)->irqCause;
    dragoniteIntrScanArray[0].maskRegAddr  = (GT_U32)&((PRV_CPSS_DRAGONITE_IRQ_MEMORY_STC*)irqMemPtr)->irqMask;
    ...
    retVal = cpssGenEventInterruptConnect(dragoniteInterruptsCtrlStruct.intVecNum,
                                          dragoniteInterruptsCtrlStruct.intMask,
                                          dragoniteInterruptsCtrlStruct.isrFuncPtr,
                                          NULL,
                                          &dragoniteInterruptsCtrlStruct.isrConnectionId);
