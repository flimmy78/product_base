...
#define TRESHOLD_AMPLITUDE_VALUE_CNS 40
...
static GT_STATUS prvGetErrGeCabLen(GT_U8 dev, GT_U8 port, GT_U8 dist, GT_U8 *lengthPtr);
static GT_STATUS prvGetErrFeCabLen(GT_U8 dev, GT_U8 port, GT_U8 dist, GT_U8 *lengthPtr);
static GT_STATUS prvGetErrGeCabLenNG(GT_U8 dev, GT_U8 port, GT_U32 dist, GT_U16  phyIdRegValue, GT_U8 *lengthPtr);
static GT_STATUS  prvPhySoftReset(GT_U8 dev, GT_U8 port);
static GT_STATUS  prvSetTdrWorkAround(GT_U8 dev, GT_U8 port);
static GT_STATUS  prvEnableTdrFe1WorkAround(GT_U8 dev, GT_U8 port);
static GT_STATUS  prvDisableTdrFe1WorkAround(GT_U8 dev, GT_U8 port);
static GT_STATUS  prvEnableTdrFe2WorkAround(GT_U8 dev, GT_U8 port);
static GT_STATUS  prvDisableTdrFe2WorkAround(GT_U8 dev, GT_U8 port);
static GT_STATUS  prvEnableTdrGeWorkAround(GT_U8 dev, GT_U8 port);
static GT_STATUS  prvDisableTdrGeWorkAround(GT_U8 dev, GT_U8 port);

static GT_STATUS prvDoesDeviceSupportVct(GT_U8 dev, GT_U8 port,
                                      CPSS_VCT_PHY_TYPES_ENT* phyType,
                                      GT_U16 *phyIdRegValue);

static GT_STATUS prvGetExtendedCableStatus_Phy100M(GT_U8 dev, GT_U8 port,
                                CPSS_VCT_CABLE_EXTENDED_STATUS_STC *extendedCableStatusPtr);
static GT_STATUS prvGetExtendedCableStatus_Phy1000M(GT_U8 dev, GT_U8 port,
                                CPSS_VCT_CABLE_EXTENDED_STATUS_STC *extendedCableStatusPtr);
static GT_STATUS prvGetExtendedCableStatus_Phy1000MMP(GT_U8 dev, GT_U8 port,
                                                   CPSS_VCT_PHY_TYPES_ENT phyType,
                                CPSS_VCT_CABLE_EXTENDED_STATUS_STC *extendedCableStatusPtr);

static GT_STATUS prvGetExtendedCableStatus_Phy1000MMP_NG(GT_U8 dev, GT_U8 port,
                                                         GT_U16 phyIdRegValue,
                                CPSS_VCT_CABLE_EXTENDED_STATUS_STC *extendedCableStatusPtr);

static GT_STATUS prvVctReady_Phy100M(GT_U8 dev, GT_U8 port);
static GT_STATUS prvVctStarted_Phy100M(GT_U8 dev,GT_U8 port, CPSS_VCT_STATE  action,
                                    CPSS_VCT_CABLE_STATUS_STC *cableStatusPtr);
static GT_STATUS prvVctRedoPhase2_Phy100M(GT_U8 dev,GT_U8 port,
                                       CPSS_VCT_CABLE_STATUS_STC *cableStatusPtr);

static GT_STATUS prvVctReady_Phy1000M(GT_U8 dev, GT_U8 port);
static GT_STATUS prvVctStarted_Phy1000M(GT_U8 dev,GT_U8 port,
                                     CPSS_VCT_CABLE_STATUS_STC *cableStatusPtr);

static GT_STATUS prvVctReady_Phy1000MMP(GT_U8 dev, GT_U8 port,
                                     CPSS_VCT_PHY_TYPES_ENT phyType,
                                     CPSS_VCT_CABLE_STATUS_STC *cableStatusPtr);
static GT_STATUS prvVctStarted_Phy1000MMP(GT_U8 dev,GT_U8 port,
                                       CPSS_VCT_CABLE_STATUS_STC *cableStatusPtr);
...
)
{
    ...
    PRV_CPSS_PHY_PORT_CHECK_MAC(devNum,port);
            ...
            for (rxPair = 0; rxPair < CPSS_VCT_MDI_PAIR_NUM_CNS; rxPair++)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(polarity)
                        {
                            if(amplitude > TRESHOLD_AMPLITUDE_VALUE_CNS)
                            {
                                 cableStatusPtr->cableStatus[txPair].testStatus =
                    ...
                    status = prvGetErrGeCabLenNG(dev, port, distToFault, phyIdRegValue,
...
)
{
    ...
    *offsetPtr = PRV_CPSS_PP_MAC(dev)->phyPortInfoArray[port].vctLengthOffset;
