...
********************************************************************************
* prvCpssDxChIpTcamEntriesHandler.c
*
* DESCRIPTION:
...
(
    ...
    OUT PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC *freeIndexesPtr
);
...
(
    ...
    OUT PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_STC                  **memPoolPtrPtr
);
...
)
{
    ...
    ipTcamShadowPtr->tcamEntriesHandler = (PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC*)
    ...
    cpssOsMemSet(ipTcamShadowPtr->tcamEntriesHandler,0,sizeof(PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC));
    ...
    if ((ipTcamShadowPtr->shadowType == CPSS_DXCH_IP_TCAM_CHEETAH_SHADOW_E) ||
        ...
        ((ipTcamShadowPtr->shadowType == CPSS_DXCH_IP_TCAM_CHEETAH3_SHADOW_E) && (partitionEnable == GT_TRUE)) ||
        ((ipTcamShadowPtr->shadowType == CPSS_DXCH_IP_TCAM_XCAT_SHADOW_E) && (partitionEnable == GT_TRUE)) ||
        (ipTcamShadowPtr->shadowType == CPSS_DXCH_IP_TCAM_XCAT_POLICY_BASED_ROUTING_SHADOW_E))
    {
        ipTcamShadowPtr->tcamEntriesHandler->operationMode = PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E;
        rc = createIpTcamMgmPools(ipTcamShadowPtr,indexesRangePtr,
                                  partitionEnable,capacityCfgPtr,
                                  protocolStack);

    }
    else if (((ipTcamShadowPtr->shadowType == CPSS_DXCH_IP_TCAM_CHEETAH3_SHADOW_E) && (partitionEnable == GT_FALSE)) ||
             ((ipTcamShadowPtr->shadowType == CPSS_DXCH_IP_TCAM_XCAT_SHADOW_E) && (partitionEnable == GT_FALSE)))
    {
        ipTcamShadowPtr->tcamEntriesHandler->operationMode = PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_NO_PARTITION_MODE_E;
    ...
    {
        ipTcamShadowPtr->tcamEntriesHandler->operationMode = PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_INVALID_MODE_E;
...
)
{
    ...
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC   pclIndexes;
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC   freeIndexes;
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_STC                  *ipTcamMemPoolMgm;
    GT_U32                                              i;
    ...
    for (i = 0; i < 2; i++)
    {
        pclIndexes.segment[i].startIndex =
            pclTcamCfgPtr->tcamRange.firstIndex + GT_IP_CORE_CHEETAH_NUM_OF_RULES_IN_COLUMN_CNS * i;
        pclIndexes.segment[i].endIndex =
            pclTcamCfgPtr->tcamRange.lastIndex + GT_IP_CORE_CHEETAH_NUM_OF_RULES_IN_COLUMN_CNS * i;
        pclIndexes.segment[i].numOfIndexes =
            pclIndexes.segment[i].endIndex - pclIndexes.segment[i].startIndex + 1;
    }

    ipTcamMemPoolMgm = cpssDxChIpTcamMgmCreate(pclTcamCfgPtr->prefixesCfg.numOfIpv4Prefixes +
                                               pclTcamCfgPtr->prefixesCfg.numOfIpv6Prefixes,
                                               pclIndexes.segment, 2, freeIndexes.segment,
                                               5, NULL, NULL);

    ipTcamShadowPtr->tcamEntriesHandler->ipTcamPool.tcamMgm[IP_TCAM_MGM_POOL_PCL_TCAM_INDEX_CNS][CPSS_IP_PROTOCOL_IPV4_E] =
        ipTcamShadowPtr->tcamEntriesHandler->ipTcamPool.tcamMgm[IP_TCAM_MGM_POOL_PCL_TCAM_INDEX_CNS][CPSS_IP_PROTOCOL_IPV6_E] =
            ipTcamMemPoolMgm;
...
{
    GT_STATUS                                   rc = GT_OK;
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_STC          *pIpTcamPool = NULL;
    PRV_CPSS_DXCH_IP_TCAM_MGM_ALLOC_METHOD_ENT  poolAllocMethod;

    /* pointer to TCAM entries handler */
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC  *tcamHandlerPtr;
    CPSS_NULL_PTR_CHECK_MAC(ipTcamShadowPtr);
    ...
    {
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E:
        ...
        switch (allocMethod)
        {
        case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MIN_E:
            poolAllocMethod = PRV_CPSS_DXCH_IP_TCAM_MGM_ALLOC_MIN_E;
            break;
        case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MID_E:
            poolAllocMethod = PRV_CPSS_DXCH_IP_TCAM_MGM_ALLOC_MID_E;
            break;
        case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MAX_E:
            poolAllocMethod = PRV_CPSS_DXCH_IP_TCAM_MGM_ALLOC_MAX_E;
            break;
        default:
            return GT_BAD_PARAM;
        }

        rc = cpssDxChIpTcamMgmAlloc(pIpTcamPool,lowerBoundPtr,upperBoundPtr,
                                    poolAllocMethod,allocNodePtrPtr);
        break;

    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_NO_PARTITION_MODE_E:
...
)
{
    ...
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E:
        ...
        rc = cpssDxChIpTcamMgmAllocByGivenRule(pIpTcamPool,allocRulePtr,allocNodePtrPtr);
        break;
...
)
{
    ...
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E:
        ...
        rc = cpssDxChIpTcamMgmFree(pIpTcamPool,allocNodePtr);
        break;
...
)
{
    ...
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E:
        ...
        rc = cpssDxChIpTcamMgmCheckAvailbleMem(pIpTcamPool,numOfRulesNeeded);
        break;
...
)
{
    ...
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E:
        ...
        rc = cpssDxChIpTcamMgmGetRuleIdx(pIpTcamPool,allocNodePtr,ruleIdxPtr);
        break;
...
)
{
    ...
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E:
        ...
        rc = cpssDxChIpTcamMgmGetRuleByRuleIdx(pIpTcamPool,ruleIdx,ruleNodePtrPtr);
        break;
...
)
{
    ...
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E:
        ...
        if (rc != GT_OK)
            return rc;
        *allocNodePtrPtr = cpssDxChIpTcamMgmSetRealIdxAsAlloc(pIpTcamPool,hwIndex);
...
{
    GT_STATUS                                   rc = GT_OK;
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_STC          *pIpTcamPoolPtr = NULL;
    GT_U32                                      ruleIndex;
    ...
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_PARTITION_MODE_E:
        /* search in IPv6 pool */
        pIpTcamPoolPtr = tcamHandlerPtr->ipTcamPool.tcamMgm[IP_TCAM_MGM_POOL_ROUTER_TCAM_INDEX_CNS][CPSS_IP_PROTOCOL_IPV6_E];
        if (pIpTcamPoolPtr != NULL)
        {
            for (i = 0 ; i < pIpTcamPoolPtr->coreIpNumOfIpTcamRules ; i++)
            {
                ...
                {
                    *entryTypePtr = PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_UC_ENTRY_E;
        ...
        pIpTcamPoolPtr = tcamHandlerPtr->ipTcamPool.tcamMgm[IP_TCAM_MGM_POOL_ROUTER_TCAM_INDEX_CNS][CPSS_IP_PROTOCOL_IPV4_E];
        if (pIpTcamPoolPtr != NULL)
        {
            for (i = 0 ; i < pIpTcamPoolPtr->coreIpNumOfIpTcamRules ; i++)
            {
                if (hwIndex == pIpTcamPoolPtr->coreIpTcamRulesAllocArray[i].offset)
                {
                    *entryTypePtr = PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_UC_ENTRY_E;
                    *ruleNodePtrPtr = &pIpTcamPoolPtr->coreIpTcamRulesAllocArray[i];
                    return GT_OK;
                }
            }
        ...
        if (pIpTcamPoolPtr != NULL)
        {
            for (i = 0 ; i < pIpTcamPoolPtr->coreIpNumOfIpTcamRules ; i++)
            {
                if (hwIndex == pIpTcamPoolPtr->coreIpTcamRulesAllocArray[i].offset)
                {
                    *entryTypePtr = PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_MC_SOURCE_ENTRY_E;
                    *ruleNodePtrPtr = &pIpTcamPoolPtr->coreIpTcamRulesAllocArray[i];
                    return GT_OK;
                }
            }
    ...
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_NO_PARTITION_MODE_E:
        ...
        switch (*entryTypePtr)
        {
        case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_UC_ENTRY_E:
        case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_MC_GROUP_ENTRY_E:
        case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV4_MC_SOURCE_ENTRY_E:
            singleTcamEntry = GT_TRUE;
            break;
        case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_UC_ENTRY_E:
        case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_MC_GROUP_ENTRY_E:
        case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_MC_SOURCE_ENTRY_E:
...
)
{
    ...
    case CPSS_DXCH_IP_TCAM_CHEETAH_SHADOW_E:
        if ((lastIpTcamLine >= GT_IP_CORE_CHEETAH_NUM_OF_RULES_IN_COLUMN_CNS) ||
            (lastIpTcamLine - firstIpTcamLine + 1 > GT_IP_CORE_CHEETAH_NUM_OF_RULES_IN_COLUMN_CNS))
        {
            return GT_BAD_PARAM;
        }
    ...
    case CPSS_DXCH_IP_TCAM_CHEETAH2_SHADOW_E:
        if ((lastIpTcamLine >= GT_IP_CORE_CHEETAH2_NUM_OF_RULES_IN_COLUMN_CNS) ||
            lastIpTcamLine - firstIpTcamLine + 1 > GT_IP_CORE_CHEETAH2_NUM_OF_RULES_IN_COLUMN_CNS)
        {
            return GT_BAD_PARAM;
        }
    ...
    case CPSS_DXCH_IP_TCAM_CHEETAH3_SHADOW_E:
        if ((lastIpTcamLine >= GT_IP_CORE_CHEETAH3_TCAM_NUM_ROWS_CEILING_CNS) ||
            lastIpTcamLine - firstIpTcamLine + 1 > GT_IP_CORE_CHEETAH3_TCAM_NUM_ROWS_CEILING_CNS)
        {
            return GT_BAD_PARAM;
        }
    ...
    case CPSS_DXCH_IP_TCAM_XCAT_POLICY_BASED_ROUTING_SHADOW_E:
        if ((lastIpTcamLine >= GT_IP_CORE_XCAT_POLICY_TCAM_NUM_OF_RULES_CEILING_CNS) ||
            (lastIpTcamLine - firstIpTcamLine + 1 > GT_IP_CORE_XCAT_POLICY_TCAM_NUM_OF_RULES_CEILING_CNS))
        {
            return GT_BAD_PARAM;
        }
...
{
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_STC_IDX_SEG_STC  idxSegment[2];
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_STC              *ipTcamMemPoolMgm;
    GT_U32                                          i;
    ...
    case CPSS_DXCH_IP_TCAM_CHEETAH_SHADOW_E:
        ...
        for (i=0; i<2; i++)
        {
            idxSegment[i].startIndex   = tcamStartIndex + GT_IP_CORE_CHEETAH_NUM_OF_RULES_IN_COLUMN_CNS * i;
            idxSegment[i].endIndex     = tcamEndIndex  + GT_IP_CORE_CHEETAH_NUM_OF_RULES_IN_COLUMN_CNS * i;
    ...
    ipTcamMemPoolMgm = cpssDxChIpTcamMgmCreate(numOfIpPrefixes,idxSegment,numOfSegments,
                                               NULL,0,NULL,NULL);
...
{
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_STC                  *ipTcamMemPoolMgm;
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC   ipv4IdxSegments;
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC   mcSrcIdxSegments;
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC   ipv6IdxSegments;

    GT_U32  lastIpTcamLineAfterIpv6;    /* last TCAM line allocated to ip      */
                                        /* after allocating ipv6 lines         */
    ...
    cpssOsMemSet(&ipv4IdxSegments,  0x00, sizeof(PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC));
    cpssOsMemSet(&mcSrcIdxSegments, 0x00, sizeof(PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC));
    cpssOsMemSet(&ipv6IdxSegments,  0x00, sizeof(PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC));
    if (freeIndexesPtr != NULL)
    {
        cpssOsMemSet(freeIndexesPtr, 0x00, sizeof(PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_ROUTER_IDX_SEG_STC));
    }
        ...
        (protocolStack == CPSS_IP_PROTOCOL_IPV4V6_E))
    {
        ...
        ipTcamMemPoolMgm = cpssDxChIpTcamMgmCreate(numOfIpv6Prefixes,
        ...
        ipTcamShadowPtr->tcamEntriesHandler->ipTcamPool.tcamMgm[IP_TCAM_MGM_POOL_ROUTER_TCAM_INDEX_CNS][CPSS_IP_PROTOCOL_IPV6_E]
                                                            = ipTcamMemPoolMgm;
    }
        ...
        (numOfReservedPrefixes > 0))
    {
        ...
        lastIpTcamLineAfterIpv6 = tcamEndIndex - numOfIpv6Prefixes;
            ...
            (protocolStack == CPSS_IP_PROTOCOL_IPV4V6_E))
        {
            ...
            ipTcamMemPoolMgm = cpssDxChIpTcamMgmCreate(numOfIpv4Prefixes,
            ...
            ipTcamShadowPtr->tcamEntriesHandler->ipTcamPool.tcamMgm[IP_TCAM_MGM_POOL_ROUTER_TCAM_INDEX_CNS][CPSS_IP_PROTOCOL_IPV4_E]
                                                                = ipTcamMemPoolMgm;

            /* create the ipv4 mc src tcam rules manager for this VR*/
            ipTcamMemPoolMgm = cpssDxChIpTcamMgmCreate(ipTcamShadowPtr->numOfIpMcSrcAddr,
...
)
{
    ...
    GT_U32                              i;
    GT_U32                              tcamIndex;
    PRV_CPSS_DXCH_IP_TCAM_MGM_POOL_STC  *poolPtr;
    ...
    if (poolPtr != NULL)
    {
        ...
        {
            tcamIndex = column * GT_IP_CORE_CHEETAH3_TCAM_NUM_ROWS_CEILING_CNS + row;
    ...
    poolPtr = ipTcamShadowPtr->tcamEntriesHandler->ipTcamPool.tcamMgm[IP_TCAM_MGM_POOL_ROUTER_TCAM_INDEX_CNS][CPSS_IP_PROTOCOL_IPV4_E];
    ...
    poolPtr = ipTcamShadowPtr->tcamEntriesHandler->ipTcamPool.tcamMgm[IP_TCAM_MGM_POOL_ROUTER_TCAM_INDEX_CNS][CPSS_IP_PROTOCOL_IPV6_E];
...
)
{
    ...
    case CPSS_DXCH_IP_TCAM_CHEETAH2_SHADOW_E:
        index = /*(GT_U8)((vrId == 0) ?*/
                IP_TCAM_MGM_POOL_ROUTER_TCAM_INDEX_CNS/* : IP_TCAM_MGM_POOL_PCL_TCAM_INDEX)*/;
        break;
    case CPSS_DXCH_IP_TCAM_CHEETAH3_SHADOW_E:
    ...
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_MC_SOURCE_ENTRY_E:
        *memPoolPtrPtr = tcamHandlerPtr->ipTcamPool.tcamMgm[index][1];
        break;
    case PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_NON_IP_ENTRY_E:
        break;
    default:
        return GT_NOT_SUPPORTED;
    }
...
{
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC  *tcamHandler;           /* used to shorten text */
    ...
    case CPSS_DXCH_IP_TCAM_CHEETAH2_SHADOW_E:
    case CPSS_DXCH_IP_TCAM_CHEETAH3_SHADOW_E:
        tcamHandler->tcamSearchOrder = PRV_CPSS_DXCH_TCAM_COLUMN_SEARCH_ORDER_E;
        break;
    case CPSS_DXCH_IP_TCAM_XCAT_SHADOW_E:
        tcamHandler->tcamSearchOrder = PRV_CPSS_DXCH_TCAM_ROW_SEARCH_ORDER_E;
        break;
    default:
        return GT_BAD_PARAM;
    }
    ...
    tcamHandler->prefixPtrArray = (PRV_CPSS_DXCH_IP_TCAM_RULE_NODE_STC *)
        cpssOsMalloc(sizeof(PRV_CPSS_DXCH_IP_TCAM_RULE_NODE_STC) * tcamHandler->numOfTcamEntries);
...
)
{
    ...
    while ((lowerBoundWord <= searchWord) && (searchWord <= upperBoundWord))
    {
        ...
        if (allocMethod == PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ALLOC_MID_E)
        {
...
)
{
    ...
    if ((searchIndex < lowerBoundIndex) || (searchIndex > upperBoundIndex))
    {
        ...
        else /* defragEnable == GT_TRUE */
        {
            ...
            rc = tcamHandlerCheckAvailbleMem(tcamHandlerPtr,PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_IPV6_UC_ENTRY_E,1);
            if (rc != GT_OK)
                return rc;
    ...
    /* convert index to offset */
    if (tcamHandlerPtr->tcamSearchOrder == PRV_CPSS_DXCH_TCAM_COLUMN_SEARCH_ORDER_E )
    {
...
)
{
    ...
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_ENTRY_TYPE_ENT entryType;/* type of entry prefix we are about to relocate */
    /* pointer to TCAM entries handler */
    PRV_CPSS_DXCH_TCAM_ENTRIES_HANDLER_STC  *tcamHandlerPtr;
    ...
    for (i = 0 ; i < 4 ; i++)
    {
        ...
        {
        case PRV_CPSS_DXCH_TCAM_COLUMN_SEARCH_ORDER_E:
            entryIndex =  i * tcamHandlerPtr->numOfTcamLines + lineIndexToFree;
            break;
        case PRV_CPSS_DXCH_TCAM_ROW_SEARCH_ORDER_E:
        ...
        /* relocate the entry */
        rc = prvCpssDxChIpPatTrieRelocatePrefix(ipTcamShadowPtr,tcamHandlerPtr->prefixPtrArray[entryIndex].trieNode);
...
)
{
    ...
    /* get the rule index */
    ruleIndex = (allocNodePtr - tcamHandlerPtr->prefixPtrArray);
    ...
    {
        if(tcamHandlerPtr->tcamSearchOrder == PRV_CPSS_DXCH_TCAM_ROW_SEARCH_ORDER_E)
        {
