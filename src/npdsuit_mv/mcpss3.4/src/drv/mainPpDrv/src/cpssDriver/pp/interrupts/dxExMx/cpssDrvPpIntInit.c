...
/*Twist-C*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_TWISTC_12_E,   */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_TWISTC_52_E,   */

/*Twist-D*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_TWISTD_XG_E,   */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_TWISTD_12_E,   */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_TWISTD_52_E,   */

/*Samba*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_SAMBA_XG_E,    */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_SAMBA_12_E,    */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_SAMBA_52_E,    */

/*Salsa*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_SALSA_12_E,    */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_SALSA_16_E,    */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_SALSA_24_E,    */

/*Cheetah,cheetah2, cheetah3*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_CHEETAH_E,                                        */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_CHEETAH_SMI_E,  SMI                               */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_CHEETAH_SMI_106_E,  SMI - Dx106                   */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_CHEETAH_HX_SMI_E,  SMI - DX249/269                */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_CHEETAH_HX_PCI_E,  PCI - DX249/269                */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_CHEETAH2_E,                                       */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_CHEETAH2_SMI_E, SMI                               */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_CHEETAH3_E,        PEX - ports [0:23] + XG [24:27]*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_CHEETAH3_SMI_E,    SMI - ports [0:23] + XG [24:27]*/

/*DXCH - xCat */
   {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_DXCH_XCAT_REV0_E,    xCat rev0, PEX - ports [0:23] + XG [24:27]*/
   {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_DXCH_XCAT_E,         xCat, PEX - ports [0:23] + XG [24:27]*/
   {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_DXCH_XCAT2_E,        xCat2, PEX/MBUS - ports [0:23] + Gig [24:27]*/

/*Tiger*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_TIGER_XG_E,*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_TIGER_12_E,*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_TIGER_52_E,*/

/*Puma*/
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_PUMA_E,    */

/*Lion */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_DXCH_LION_PORT_GROUP_ID_0_E, Lion, portGroupId 0 - PEX 12 GE/XG ports */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_DXCH_LION_PORT_GROUP_ID_1_E, Lion, portGroupId 1 - PEX 12 GE/XG ports */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_DXCH_LION_PORT_GROUP_ID_2_E, Lion, portGroupId 2 - PEX 12 GE/XG ports */
    {0,NULL,NULL,0,NULL,0,NULL,GT_FALSE,0,NULL},  /*PRV_CPSS_DRV_FAMILY_DXCH_LION_PORT_GROUP_ID_3_E, Lion, portGroupId 3 - PEX 12 GE/XG ports */
};
...
)
{
    ...
    retVal = prvCpssDrvPpObjConfig[devNum]->genPtr->drvHwPpInitInMasks(devNum,portGroupId,GT_TRUE,GT_FALSE);
    /*retVal = prvCpssDrvPpObjConfig[devNum]->genPtr->drvHwPpInitInMasks(devNum,portGroupId,GT_FALSE); */
    /* Here we add GT_FALSE in the last, because the system no UP !!! zhangdi */
    return retVal;
}
...
/*
 * by qinhs@autelan.com Jul. 29 2008
 *	for disable some interrupts when system is starting up, 
 *	and enable these interrupts after system is running.
 */
#ifndef __AX_PLATFORM__
	prvCpssDrvPpConfig[devNum]->intCtrl.accessAfterSysUp = cpssOsMalloc(sizeof(GT_BOOL)* (devIntPtr->numOfInterrupts>> 5));
#endif
    if(prvCpssDrvPpConfig[devNum]->intCtrl.portGroupInfo[portGroupId].intMaskShadow == NULL ||
#ifndef __AX_PLATFORM__
       prvCpssDrvPpConfig[devNum]->intCtrl.accessAfterSysUp == NULL ||
#endif
    ...
    for(i = 0; i < devIntPtr->numOfInterrupts ; i++)
    {
        ...
        if((i % 32) == 0)
        {
            ...
            prvCpssDrvPpConfig[devNum]->intCtrl.accessB4StartInit[i / 32] = GT_TRUE;/*luoxun --diff*/

            
#ifndef __AX_PLATFORM__
			if((0x00000034 == devIntPtr->maskRegistersAddressesArray[i / 32]) ||
				(0x00000118 == devIntPtr->maskRegistersAddressesArray[i / 32]))
			{
                #if 0
				osPrintf("drvInterruptsInit::reg %#0x shadow %#0x skip\n",	\
						devIntPtr->maskRegistersAddressesArray[i / 32],
						prvCpssDrvPpConfig[devNum]->intCtrl.intMaskShadow[i / 32]);
                #endif
                prvCpssDrvPpConfig[devNum]->intCtrl.accessB4StartInit[i / 32]
                    = GT_FALSE;
				prvCpssDrvPpConfig[devNum]->intCtrl.accessAfterSysUp[i / 32] 
					= GT_TRUE;
			}
			else 
			{
...
)
{
    ...
    GT_BOOL wasSubTree;
    GT_U32  currentLevel;
    GT_U32  treeNumLeafs[16]={0};
    GT_U32  isPuma = GT_FALSE;
    GT_U32  pexAddr = 0;
    GT_U32  dummyMaskRegAddr = 0;/* register address to be used to fill all the
    ...
    switch(devFamily)
    {
        case CPSS_PP_FAMILY_PUMA_E :
            isPuma = GT_TRUE;
            pexAddr = 0x00071910;
            dummyMaskRegAddr = 0x000000F4;/*user defined register*/
            break;
        ...
        case  CPSS_PP_FAMILY_DXCH_XCAT2_E:
            pexAddr = 0xFFFFFFFF; /* unused register address */
            dummyMaskRegAddr = 0x000000F4;/*user defined register*/
            break;
            break;
    ...
    for(ii = 0 ; ii < numScanElements; ii++)
    {
        ...
        for(jj = 0 ; jj < intrScanArr[ii].subIntrListLen; jj++)
        {
            ...
            if(((lastIndexChecked + 1) < numScanElements) &&
                wasSubTree == GT_FALSE &&
                intrScanArr[lastIndexChecked + 1].subIntrListLen != 0)
            {
    ...
    for(ii = 0 ; ii < numScanElements; ii++)
    {
        ...
        if(maskRegMapArr[enumerationInterruptIndex] != dummyMaskRegAddr &&
           maskRegMapArr[enumerationInterruptIndex] != pexAddr )/* there are 2 leaf point to the same register of PEX */
        {
            /* already set !? */
