...
extern GT_BOOL prvCpssDxChLionDuplicatedMultiPortGroupsGet
(
    IN GT_U32                   regAddr,
    ...
    {0, GT_FALSE, 0, NULL, 0x00000030, 0x00000034,
        ...
        */
        ...
        {20, GT_FALSE,0, NULL, 0x00000080, 0x00000084,
             ...
             FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 27 ,NULL, NULL},
...
/* Lion DMA Rx.  luoxun@autelan.com */
#define RXSDMA_NSBM (~(0xFFFFFFFF<<22))
const PRV_CPSS_DRV_INTERRUPT_SCAN_STC lionSdmaRxPollArr[] =
{
    /* Rx SDMA  */
    {22, GT_FALSE,0, NULL, 0x0000280C, 0x00002814,
         prvCpssDrvHwPpPortGroupIsrRead,
...
unsigned int lionSdmaRxPollSize = sizeof(lionSdmaRxPollArr)/sizeof(PRV_CPSS_DRV_INTERRUPT_SCAN_STC);
#endif
    ...
    */
        ...
        devFamilyPtr++)
    {
        ...
        for(ii = 0 ; ii < LION_NUM_MASK_REGISTERS_CNS; ii++)
        {
            ...
            if(GT_TRUE == prvCpssDxChLionDuplicatedMultiPortGroupsGet(lionMaskRegMapArr[ii],&portGroupsBmp))
            {
