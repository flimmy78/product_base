...
/* zhangdi add for Rx Polling 2011-03-10 */

/* NSBM  Non - Sum - Bit - Mask (except self) */
#define RXSDMA_NSBM (~(0xFFFFFFFF<<22))
const PRV_CPSS_DRV_INTERRUPT_SCAN_STC xcatSdmaRxPollArr[] =
{
        /* Rx SDMA  */
    {20, GT_FALSE,0, NULL, 0x0000280C, 0x00002814,
        prvCpssDrvHwPpPortGroupIsrRead,
...
unsigned int xcatSdmaRxPollSize = sizeof(xcatSdmaRxPollArr)/sizeof(PRV_CPSS_DRV_INTERRUPT_SCAN_STC);
/* add end */
