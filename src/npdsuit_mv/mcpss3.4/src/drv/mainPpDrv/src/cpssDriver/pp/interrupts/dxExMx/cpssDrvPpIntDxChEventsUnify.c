...
static GT_U16 ppUni2IntCauseType[][TABLE_ENTRY_SIZE_E] = {
      ...
      EV_INDEX_ONLY_DIFF_NAME_FOR_PP(BM_PORT_RX_BUFFERS_CNT_UNDERRUN ,BM_XG_CNT_UNDERRUN            ,2) ,
      ...
      EV_INDEX_ONLY_DIFF_NAME_FOR_PP(BM_PORT_RX_BUFFERS_CNT_OVERRUN  ,BM_XG_CNT_OVERRUN            ,2) ,
    ...
    FROM_XCAT1_EV_INDEX_ONLY_DIFF_NAME_FOR_PP(PCL_CONFIG_TABLE_DATA_ERROR, POLICY_ENGINE_PCL_CONFIG_TABLE_0_PARITY_ERROR,0),
    FROM_XCAT1_EV_INDEX_ONLY_DIFF_NAME_FOR_PP(PCL_CONFIG_TABLE_DATA_ERROR, POLICY_ENGINE_PCL_CONFIG_TABLE_1_PARITY_ERROR,1),
...
)
{
    ...
    *extDataPtr = 0;
    ...
    isPerPortPerLane = lionIsPerPortPerLaneInterrupt(intCauseIndex);
    ...
    {
        /*check if the interrupt is 'per port' */
        isPerPort = lionIsPerPortInterrupt(intCauseIndex);
    }
