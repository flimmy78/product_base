...
/* matched MAC DA  */
static GT_U8 prvTgfMathedMacDa[]   =  {0x00, 0x00, 0x00, 0x00, 0x34, 0x02};

/* unmatched MAC SA  */
static GT_U8 prvTgfUnmathedMacDa[] =  {0x00, 0x00, 0x00, 0x00, 0x34, 0x03};

/* matched MAC SA  */
static GT_U8 prvTgfMathedMacSa[]   =  {0x00, 0x00, 0x00, 0x00, 0x00, 0x11};

/* unmatched MAC SA  */
static GT_U8 prvTgfUnmathedMacSa[] =  {0x00, 0x00, 0x00, 0x00, 0x00, 0x12};
...
/* the L2 part of the packet - updated during the test*/
...
/*******************************************************************************
* prvTgfPclLookup00And01QosUpSet
*
* DESCRIPTION:
*       None
*
...
*
*******************************************************************************/
static GT_STATUS prvTgfPclLookup00And01QosUpSet
(
    IN GT_U8 portNum,
...
)
{
    ...
    rc = prvTgfPclLookup00And01QosUpSet(
            prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],
            PRV_TGF_QOS_PROFILE_DEFAULT_CNS, /*qosProfileIdxPort*/
            GT_TRUE);               /* reset */
    PRV_UTF_VERIFY_RC1(rc, "prvTgfPclLookup00And01QosUpSet");
...
/*******************************************************************************
* prvTgfPclLookup00And01TrafficGenerate
*
* DESCRIPTION:
*       None
*
...
*
*******************************************************************************/
static GT_STATUS prvTgfPclLookup00And01TrafficGenerate
(
...
/*******************************************************************************
* prvTgfPclLookup00And01PclCfgTblSet
*
* DESCRIPTION:
*       None
*
...
*
*******************************************************************************/
static GT_STATUS prvTgfPclLookup00And01PclCfgTblSet
(
    IN GT_U8                         portNum
)
{
    ...
    rc = prvTgfPclCfgTblSet(
        &interfaceInfo, direction, CPSS_PCL_LOOKUP_0_0_E, &lookupCfg);
    PRV_UTF_VERIFY_GT_OK(rc, "prvTgfPclCfgTblSet 0_0");
    ...
    PRV_UTF_VERIFY_GT_OK(rc, "prvTgfPclCfgTblSet 0_1");

    return rc;
}

/*******************************************************************************
* prvTgfPclLookup00And01PclRuleSet
*
* DESCRIPTION:
*       None
*
...
*
*******************************************************************************/
static GT_STATUS prvTgfPclLookup00And01PclRuleSet
(
...
*
*******************************************************************************/
static GT_VOID prvTgfPclLookup00And01Check
(
    IN  GT_BOOL matchLookup0_0,
    IN  GT_BOOL matchLookup0_1
)
{
    GT_STATUS rc = GT_OK;
    GT_U32    numTriggers;
    ...
    PRV_UTF_LOG2_MAC(
        " check match_0_0: %d, match_0_1: %d\n",
        matchLookup0_0, matchLookup0_1);

    /* update the packet's MACs */
    if (matchLookup0_0 == GT_FALSE)
    {
        cpssOsMemCpy(
            prvTgfPacketL2Part.daMac, prvTgfUnmathedMacDa, 6);
        expectedUp = PRV_TGF_QOS_PROFILE_DEFAULT_CNS;
    }
    else
    {
        cpssOsMemCpy(
            prvTgfPacketL2Part.daMac, prvTgfMathedMacDa, 6);
        expectedUp = PRV_TGF_QOS_PROFILE_NEW_CNS;
    }

    if (matchLookup0_1 == GT_FALSE)
    {
        cpssOsMemCpy(
            prvTgfPacketL2Part.saMac, prvTgfUnmathedMacSa, 6);
        expectedVid = PRV_TGF_VLANID_CNS;
    }
    else
    {
        cpssOsMemCpy(
            prvTgfPacketL2Part.saMac, prvTgfMathedMacSa, 6);
        expectedVid = PRV_TGF_VID_NEW_CNS;
    }

    /* send packet and check ETH counters */
    rc = prvTgfPclLookup00And01TrafficGenerate(
    ...
    UTF_VERIFY_EQUAL1_STRING_MAC(
        GT_OK, rc, "prvTgfPclLookup00And01TrafficGenerate: %d", prvTgfDevNum);
...
)
{
    ...
    rc = prvTgfBrgDefFdbMacEntryOnPortSet(
            prvTgfMathedMacDa, PRV_TGF_VLANID_CNS, prvTgfDevNum,
            prvTgfPortsArray[PRV_TGF_FDB_PORT_IDX_CNS], GT_TRUE);
    PRV_UTF_VERIFY_RC1(rc, "prvTgfBrgDefFdbMacEntryOnPortSet");

    /* create a macEntry for unmatched macDa */
    rc = prvTgfBrgDefFdbMacEntryOnPortSet(
            prvTgfUnmathedMacDa, PRV_TGF_VLANID_CNS, prvTgfDevNum,
            prvTgfPortsArray[PRV_TGF_FDB_PORT_IDX_CNS], GT_TRUE);
    PRV_UTF_VERIFY_RC1(rc, "prvTgfBrgDefFdbMacEntryOnPortSet");
    ...
    /* init PCL and set 2 PCL Lookups 0_0, 0_1 */
    rc = prvTgfPclLookup00And01PclCfgTblSet(
            prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS]);
    PRV_UTF_VERIFY_RC1(
        rc, "prvTgfPclLookup00And01PclCfgTblSet");

    rc = prvTgfPclLookup00And01PclRuleSet(
        prvTgfPclIndex[0],
        ...
        &vlanNone);
    PRV_UTF_VERIFY_RC1(
        rc, "prvTgfPclLookup00And01PclRuleSet rule0");
    ...
    rc = prvTgfPclLookup00And01PclRuleSet(
        ...
        &vlanNewVid);
    PRV_UTF_VERIFY_RC1(
        rc, "prvTgfPclLookup00And01PclRuleSet rule1");
    ...
    prvTgfPclLookup00And01Check(
        GT_FALSE /*matchLookup0_0*/,
        GT_FALSE /*matchLookup0_1*/);

    prvTgfPclLookup00And01Check(
        GT_TRUE /*matchLookup0_0*/,
        GT_FALSE /*matchLookup0_1*/);

    prvTgfPclLookup00And01Check(
        GT_FALSE /*matchLookup0_0*/,
        GT_TRUE /*matchLookup0_1*/);
