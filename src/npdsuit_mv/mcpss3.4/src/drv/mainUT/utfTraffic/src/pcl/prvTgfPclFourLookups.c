...
static GT_U32  prvTgfPclIndex[4] = {1, 12, 3, 8};
...
/*******************************************************************************
* prvTgfPclFourLookupsTrafficGenerate
*
* DESCRIPTION:
*       None
*
...
/*******************************************************************************
* prvTgfPclFourLookupsPclCfgTblSet
*
* DESCRIPTION:
*       None
*
...
/*******************************************************************************
* prvTgfPclFourLookupsPclRuleSet
*
* DESCRIPTION:
*       None
*
...
)
{
    ...
    qosRedirectPort.data.outIf.outInterface.devPort.devNum = prvTgfDevNum;
    ...
    qosNewUp.modifyDscp = CPSS_PACKET_ATTRIBUTE_MODIFY_DISABLE_E;
    ...
    qosEgrNewDscp.modifyDscp = CPSS_PACKET_ATTRIBUTE_MODIFY_ENABLE_E;
