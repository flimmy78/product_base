...
/* L2 part of packet */
static TGF_PACKET_L2_STC prvTgfPacketL2Part = {{0x00, 0x00, 0x00, 0x00, 0x34, 0x02},
...
)
{
    ...
    /* restore counter for drop packets */
