...
)
{
    ...
    uploadSet.timer.secondTimer.l[0] = 0xFFFFFFFF - 5;
    ...
    if(GT_TRUE ==  prvTgfPolicerStageCheck(PRV_TGF_POLICER_STAGE_INGRESS_1_E))
    {
        ...
        UTF_VERIFY_EQUAL0_STRING_MAC(0xFFFFFFFF - 5, uploadGet.timer.secondTimer.l[0],
                                     "Upload second.l[0] different then expected");
    ...
    if( timerGet.secondTimer.l[0] < 9 ||
        timerGet.secondTimer.l[0] > 11 )
    {
        UTF_VERIFY_EQUAL0_STRING_MAC(10, timerGet.secondTimer.l[0],
    ...
    if(GT_TRUE ==  prvTgfPolicerStageCheck(PRV_TGF_POLICER_STAGE_EGRESS_E))
    {
        ...
        if( timerGet.secondTimer.l[0] < 109 ||
            timerGet.secondTimer.l[0] > 111 )
        {
            UTF_VERIFY_EQUAL0_STRING_MAC(110, timerGet.secondTimer.l[0],
                                         "ipfix second.l[0] different then expected");
        }
