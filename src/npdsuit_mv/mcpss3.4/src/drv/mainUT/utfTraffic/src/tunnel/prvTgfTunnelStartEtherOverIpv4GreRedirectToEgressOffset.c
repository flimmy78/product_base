...
)
{
    ...
    /* enable length offset per egress port */
...
)
{
    ...
    /* Setup PCL ingress Policy on port */
...
)
{
    ...
    TGF_VFD_INFO_STC         vfdArray[PRV_TGF_VFD_NUM_CNS] = {{0}};
    ...
    vfdArray[5].patternPtr[1] = 0x46 + PRV_TGF_TUNNEL_OFFSET_CNS;
