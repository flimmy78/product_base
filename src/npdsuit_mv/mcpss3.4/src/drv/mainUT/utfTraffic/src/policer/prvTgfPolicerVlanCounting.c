...
*
* DESCRIPTION:
*       Set Default Vlan Policer configuration.
*
* INPUTS:
*       None
*
...
*
*******************************************************************************/
GT_STATUS prvTgfPolicerVlanConfigurationRestore
(
    GT_VOID
)
{
...
/*******************************************************************************
* prvTgfDefPolicerVlanStageConfigurationSet
*
* DESCRIPTION:
*       None
*
...
/*******************************************************************************
* prvTgfPolicerVlanStageConfigurationRestore
*
* DESCRIPTION:
*       None
*
...
/*******************************************************************************
* prvTgfVlanPolicerTestPacketSend
*
* DESCRIPTION:
...
/*******************************************************************************
* prvTgPolicerVlanfTrafficGenerate
*
* DESCRIPTION:
*       Generate traffic:
...
)
{
    ...
    {
        expectedCount += (prvTgfBurstCount * 4);
    ...
    prvTgfPacketVlanTag0Part.vid = 3;

    /* create vlan 3 on ports (0,0), (0,8), (0,18), (0,23) */
    rc = prvTgfBrgDefVlanEntryWrite(3);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgDefVlanEntryWrite: %d", prvTgfDevNum);
    ...
    /* Check that Vlan counter [2] value is zero */
    ...
    /* Invalidate Vlan 3*/
    rc = prvTgfBrgVlanEntryInvalidate(3);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgDefVlanEntryWrite: %d", prvTgfDevNum);
    ...
    for (i = 0; i < PRV_TGF_VLAN_TRIGGER_PKT_CMD_NUM_CNS; i++)
    {
        ...
        else
        {
            /* What will be counted:
               ...
               - Trap +1
               - Mirror To CPU  + 2 because this command produced two packets
               - all From CPU packets on Send port */
            cntrValToExpect = 4 + PRV_TGF_SEND_COUNT_CNS;
