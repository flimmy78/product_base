...
/* type of the tunnel */
static CPSS_TUNNEL_TYPE_ENT prvTgfTunnelType = CPSS_TUNNEL_X_OVER_GRE_IPV4_E;
...
/*******************************************************************************
* prvTgfTunnelStartIpv4overGreIpv4LttRouteConfigurationSet
*
* DESCRIPTION:
...
/*******************************************************************************
* prvTgfTunnelStartIpv4overGreIpv4PbrConfigurationSet
*
* DESCRIPTION:
...
)
{
    ...
    tunnelType = CPSS_TUNNEL_IPV4_OVER_IPV4_E; /* eliminate Coverity warning */
