...
/*******************************************************************************
* prvTgfPolicerAllCountersGet
*
* DESCRIPTION:
*       Get the value of specified Management and Policy Counters
*
* INPUTS:
*       None
*
...
/*******************************************************************************
* prvTgfPolicerCountersCheck
*
* DESCRIPTION:
*       Check the value of specified Management and Policy Counters
*
* INPUTS:
*       None
*
...
)
{
    ...
    portGroupBmp    = (1 << (sendPortNum >> 4));

    /* configure only relevant port group */
    usePortGroupsBmp  = GT_TRUE;
    currPortGroupsBmp = portGroupBmp;
    ...
    /* disable ingress policy on FDB_Port */
    rc = prvTgfPclPortIngressPolicyEnable(
    ...
    rc = prvTgfEthCountersCheck(prvTgfDevNum,
        receivePortNum,
        (GT_U8)expectedRcvPackets, (GT_U8)expectedRcvPackets,
...
)
{
    ...
    for (sendIter = 0; (sendIter < 4); sendIter++)
    {
        ...
        prvTgfPclPortGroupPolicerTestIter(
            ...
            ((sendIter + 1) & 0x03) /* receive port index */,
            patternPtr);
