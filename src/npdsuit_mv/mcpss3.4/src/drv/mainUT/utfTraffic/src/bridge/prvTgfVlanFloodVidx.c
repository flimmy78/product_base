...
\******************************************************************************/
/*******************************************************************************
* prvTgfBrgVlanFloodVidxTestInit
*
* DESCRIPTION:
*       Set VLAN entry with recieved flood VIDX mode.
*
* INPUTS:
...
/*******************************************************************************
* prvTgfBrgVlanFloodVidxTestPacketSend
*
* DESCRIPTION:
...
/*******************************************************************************
* prvTgfBrgVlanFloodVidxTestTableReset
*
* DESCRIPTION:
...
)
{
    ...
    /* set port bitmap */
    portBitmap.ports[prvTgfPortsArray[0] >> 5] |= 1 << (prvTgfPortsArray[0] & 0x1f);
    portBitmap.ports[prvTgfPortsArray[1] >> 5] |= 1 << (prvTgfPortsArray[1] & 0x1f);
...
)
{
    ...
    for (portIter = 0; portIter < portsCount; portIter++)
    {
        ...
        if ((((portBitmap.ports[prvTgfPortsArray[portIter] >> 5] >> (prvTgfPortsArray[portIter] & 0x1f)) & 1 ) != 0) ||
...
)
{
    ...
    while (rc != GT_OK && vidx > 10) /* support devices that supports less then 4k VIDX */
    {
