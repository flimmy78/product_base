...
/*******************************************************************************
* prvTgfIpNonExactMatchRoutingIpv6UcPortCountersCheck
*
* DESCRIPTION:
...
/*******************************************************************************
* prvTgfIpNonExactMatchRoutingIpv6UcCapturedPacketsVerify
*
* DESCRIPTION:
...
)
{
    ...
    rc = prvTgfIpPortRoutingEnable(prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],
                                   CPSS_UNICAST_E, CPSS_IP_PROTOCOL_IPV6_E, GT_TRUE);
