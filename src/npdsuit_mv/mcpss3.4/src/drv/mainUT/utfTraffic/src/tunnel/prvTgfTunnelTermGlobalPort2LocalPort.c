...
typedef struct
{
    prvTgfPortTestConfig conf[4]; /* each test has 4 configurations */
}prvTgfPortTestConfigStruct;

/********************** Test 1: pattern mask configuration ********************/
static prvTgfPortTestConfigStruct confTest1 =
{
    /* Test 1: Sending Basic IPv4 Tunnel Termination - to All Port Groups, local port 3
               ...
               all group ports. Write to all port groups, local port 3: ports - 3, 19, 35, 51 */
   {{{GT_FALSE,0x2, GT_FALSE,0,0},{GT_FALSE,0xF,GT_FALSE,0,0}}, /* local port 3, port group 0 */
    {{GT_FALSE,0x12,GT_FALSE,0,0},{GT_FALSE,0xF,GT_FALSE,0,0}}, /* local port 3, port group 1 */
    {{GT_FALSE,0x22,GT_FALSE,0,0},{GT_FALSE,0xF,GT_FALSE,0,0}}, /* local port 3, port group 2 */
    {{GT_FALSE,0x32,GT_FALSE,0,0},{GT_FALSE,0xF,GT_FALSE,0,0}}} /* local port 3, port group 3 */
};
...
static prvTgfPortTestConfigStruct confTest2 =
{
   ...
   {{{GT_FALSE,0x2, GT_FALSE,0,0},{GT_TRUE,0x3F,GT_FALSE,0,0}}, /* local port 3, port group 0 */
    {{GT_FALSE,0x12,GT_FALSE,0,0},{GT_TRUE,0x3F,GT_FALSE,0,0}}, /* local port 3, port group 1 */
    {{GT_FALSE,0x22,GT_FALSE,0,0},{GT_TRUE,0x3F,GT_FALSE,0,0}}, /* local port 3, port group 2 */
    {{GT_FALSE,0x32,GT_FALSE,0,0},{GT_TRUE,0x3F,GT_FALSE,0,0}}} /* local port 3, port group 3 */
};

/********************** Test 3: pattern mask configuration ********************/
static prvTgfPortTestConfigStruct confTest3 =
{
    /* Test 3: Sending Basic IPv4 Tunnel Termination - to 2 Port Groups, local port 3
               ...
               Write to port groups 0,2, and then 1,3 local port 3.
               ...
               Write to port groups 0,1, and then 2,3 local port 3 */
   {{{GT_FALSE,0x2, GT_FALSE,0,0},{GT_TRUE,0x1F,GT_FALSE,0,0}}, /* Write to port groups 0,2, local port 3 */
    {{GT_FALSE,0x12,GT_FALSE,0,0},{GT_TRUE,0x1F,GT_FALSE,0,0}}, /* Write to port groups 1,3, local port 3 */
    {{GT_FALSE,0x2, GT_FALSE,0,0},{GT_TRUE,0x2F,GT_FALSE,0,0}}, /* Write to port groups 0,1, local port 3 */
    {{GT_FALSE,0x22,GT_FALSE,0,0},{GT_TRUE,0x2F,GT_FALSE,0,0}}} /* Write to port groups 2,3, local port 3 */

};

typedef struct
{
    GT_U8  Tx; /* expected results: Tx port */
    GT_U8  Rx; /* expected results: Rx port */
} prvTgfPortRxTx;

typedef struct
{
    prvTgfPortRxTx transmission[4]; /* each iteration has 4 transmission */
}prvTgfPortRxTxCounters;

typedef struct
{
    prvTgfPortRxTxCounters iteration[4]; /* each test has 4 iteration */
}prvTgfPortRxTxCountersConfig;

/************************* Test 1: Port Rx Tx Counters ***********************/
static prvTgfPortRxTxCountersConfig TxRxTest1 =
{   /* iteration 0 */
  {{{{PRV_TGF_SEND_PORT1_NUM_CNS,PRV_TGF_NEXTHOPE_PORT_NUM_CNS},  /* transmission 0 */
     {PRV_TGF_SEND_PORT2_NUM_CNS,PRV_TGF_NEXTHOPE_PORT_NUM_CNS},  /* transmission 1 */
     {PRV_TGF_SEND_PORT3_NUM_CNS,PRV_TGF_NEXTHOPE_PORT_NUM_CNS},  /* transmission 2 */
     {PRV_TGF_SEND_PORT4_NUM_CNS,PRV_TGF_NEXTHOPE_PORT_NUM_CNS}}},/* transmission 3 */
    /* iteration 1 */
   {{{PRV_TGF_SEND_PORT1_NUM_CNS,PRV_TGF_NEXTHOPE_PORT_NUM_CNS},  /* transmission 0 */
     {PRV_TGF_SEND_PORT2_NUM_CNS,PRV_TGF_NEXTHOPE_PORT_NUM_CNS},  /* transmission 1 */
     {PRV_TGF_SEND_PORT3_NUM_CNS,PRV_TGF_NEXTHOPE_PORT_NUM_CNS},  /* transmission 2 */
...
{   /* iteration 0 */
  {{{{PRV_TGF_SEND_PORT1_NUM_CNS,PRV_TGF_NEXTHOPE_PORT_NUM_CNS},   /* transmission 0 */
     {PRV_TGF_SEND_PORT2_NUM_CNS,PRV_TGF_NON_EXISTING_PORT},       /* transmission 1 */
     {PRV_TGF_SEND_PORT3_NUM_CNS,PRV_TGF_NON_EXISTING_PORT},       /* transmission 2 */
     {PRV_TGF_SEND_PORT4_NUM_CNS,PRV_TGF_NON_EXISTING_PORT}}},     /* transmission 3 */
    /* iteration 1 */
   {{{PRV_TGF_SEND_PORT1_NUM_CNS,PRV_TGF_NON_EXISTING_PORT},       /* transmission 0 */
     {PRV_TGF_SEND_PORT2_NUM_CNS,PRV_TGF_NEXTHOPE_PORT_NUM_CNS},   /* transmission 1 */
     {PRV_TGF_SEND_PORT3_NUM_CNS,PRV_TGF_NON_EXISTING_PORT},       /* transmission 2 */
     {PRV_TGF_SEND_PORT4_NUM_CNS,PRV_TGF_NON_EXISTING_PORT}}},     /* transmission 3 */
    /* iteration 2 */
...
)
{
    ...
    for (portIter = 0; portIter < PRV_TGF_PORT_COUNT_CNS -1; portIter++)
    {
        ...
        rc = prvTgfIpPortRoutingEnable(prvTgfPortsArray[portIter], CPSS_IP_UNICAST_E,
    ...
    regularEntryPtr->nextHopInterface.devPort.portNum = PRV_TGF_NEXTHOPE_PORT_NUM_CNS;
...
)
{
    ...
    nextHopInfo.pclIpUcAction.redirect.data.outIf.outInterface.devPort.portNum = PRV_TGF_NEXTHOPE_PORT_NUM_CNS;
...
)
{
    ...
    case 3:
        ...
        break;
    default:
        utfFailureMsgLog("test number is incorrect.", NULL, 0);
        return;
    }
...
)
{
    ...
    portInterface.devPort.portNum = PRV_TGF_NEXTHOPE_PORT_NUM_CNS;

    /* enable capture on nexthope port */
    rc = tgfTrafficGeneratorPortTxEthCaptureSet(&portInterface, TGF_CAPTURE_MODE_MIRRORING_E, GT_TRUE);
    UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, rc, "ERROR of tgfTrafficGeneratorPortTxEthCaptureSet: %d, &d\n",
                                 prvTgfDevNum, PRV_TGF_NEXTHOPE_PORT_NUM_CNS);
