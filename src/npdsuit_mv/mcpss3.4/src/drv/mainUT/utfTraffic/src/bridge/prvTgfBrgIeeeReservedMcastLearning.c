...
\******************************************************************************/
/*******************************************************************************
* prvTgfBrgGenPortIeeeReservedMcastLearningCfg
*
* DESCRIPTION:
*       Set VLAN entry.
*
* INPUTS:
*       enableLearning  - GT_TRUE: enable Ieee Reserved Multicast learning
...
*       trapEnable      - GT_FALSE: Trapping or mirroring to CPU of packet with
...
/*******************************************************************************
* prvTgfBrgGenIeeeReservedMcastLearningPacketSend
*
* DESCRIPTION:
*       Function sends packet, performs trace and check expected results.
*
* INPUTS:
*       expectPacketNum - expected packets number captured to CPU
*
* OUTPUTS:
*       None
*
...
/*******************************************************************************
* prvTgfBrgGenIeeeReservedMcastLearningCheckFdb
*
* DESCRIPTION:
*       Get MAC entry.
*
* INPUTS:
*       expectedResult - expected result for mac entry get
*
* OUTPUTS:
*       None
*
...
/*******************************************************************************
* prvTgfBrgGenIeeeReservedMcastLearningTrafficGenerate
*
* DESCRIPTION:
...
)
{
    ...
    /* send L2 packet and trap it to CPU */
    ...
    /* Restore default IEEE Reserved Multicast configuration */
