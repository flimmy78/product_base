...
/*******************************************************************************
* prvTgfBasicIpv4UcRoutingLttRouteConfigurationSet
*
* DESCRIPTION:
...
/*******************************************************************************
* prvTgfBasicIpv4UcRoutingPbrConfigurationSet
*
* DESCRIPTION:
...
)
{
    ...
    switch(routingMode)
    {
        case PRV_TGF_IP_ROUTING_MODE_PCL_ACTION_E:
            ...
            prvTgfBasicIpv4UcRoutingPbrConfigurationSet(sendPortNum, nextHopPortNum);
            break;

        case PRV_TGF_IP_ROUTING_MODE_IP_LTT_ENTRY_E:

            prvTgfBasicIpv4UcRoutingLttRouteConfigurationSet(sendPortNum, nextHopPortNum);
            break;
