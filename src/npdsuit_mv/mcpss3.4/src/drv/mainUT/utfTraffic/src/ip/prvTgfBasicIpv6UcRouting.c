...
)
{
    ...
    /* create a vlan on ports (0,0), (0,8)Tag, (0,18) */
    ...
    /* create a vlan on port (0,23)Tag */
...
/*******************************************************************************
* prvTgfBasicIpv6UcRoutingLttRouteConfigurationSet
*
* DESCRIPTION:
...
)
{
    ...
    cpssOsMemCpy(ipAddr.arIP, prvTgfPacketIpv6Part.dstAddr, sizeof(ipAddr.arIP));
        ...
        PRV_UTF_LOG0_MAC("   wrongIPv6Addr =");
        for (ii = 0; ii < 16; ii++)
            PRV_UTF_LOG1_MAC(" %02x", ipAddr.arIP[ii]);
        PRV_UTF_LOG0_MAC("\n");
    ...
    for (ii = 0; ii < 8; ii++)
    {
        ...
        PRV_UTF_LOG0_MAC("   rightIPv6Addr =");
        for (ii = 0; ii < 16; ii++)
            PRV_UTF_LOG1_MAC(" %02x", ipAddr.arIP[ii]);
        PRV_UTF_LOG0_MAC("\n");
...
/*******************************************************************************
* prvTgfBasicIpv6UcRoutingPbrConfigurationSet
*
* DESCRIPTION:
