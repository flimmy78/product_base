...
/*******************************************************************************
* prvTgfTunnelTermEtherTypeTestInit
*
* DESCRIPTION:
...
*       vrfIdAssign - assign VRF ID for packet
...
)
{
    ...
    /* set the lookup Mac mode for Ethernet and DA */
...
/*******************************************************************************
* prvTgfTunnelTermEtherTypeConfigRestore
*
* DESCRIPTION:
