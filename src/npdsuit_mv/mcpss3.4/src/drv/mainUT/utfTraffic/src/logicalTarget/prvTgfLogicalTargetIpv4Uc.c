...
{
    GT_STATUS                rc = GT_OK;
    PRV_TGF_OUTLIF_INFO_STC  logicalTargetMappingEntry;

    /* init logical target mapping entry structure */
    cpssOsMemSet(&logicalTargetMappingEntry, 0, sizeof(logicalTargetMappingEntry));
    logicalTargetMappingEntry.interfaceInfo.type = CPSS_INTERFACE_PORT_E;
    logicalTargetMappingEntry.interfaceInfo.devPort.devNum = prvTgfDevNum;
    logicalTargetMappingEntry.interfaceInfo.devPort.portNum = prvTgfPortsArray[PRV_TGF_NEXTHOPE_PORT_IDX_CNS];
    logicalTargetMappingEntry.outlifType = PRV_TGF_OUTLIF_TYPE_LL_E; /* no tunnel */

    /* enable logical target mapping feature */
    ...
    /* Enable  a target device to be considered as a logical device */
    ...
    /* set target logical mapping entry */
...
)
{
    ...
    regularEntryPtr->nextHopInterface.devPort.devNum = prvTgfLogicalTargetDevNum;
...
)
{
    ...
    /* disable  a target device to be considered as a logical device */
    rc = prvTgfLogicalTargetMappingDeviceEnableSet(prvTgfDevNum,
                                                   prvTgfLogicalTargetDevNum,
                                                   GT_FALSE);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfLogicalTargetMappingDeviceEnableSet: %d",
    ...
    /* disable logical target mapping feature */
    rc = prvTgfLogicalTargetMappingEnableSet(prvTgfDevNum,
                                             GT_FALSE);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfLogicalTargetMappingEnableSet: %d",
                                 prvTgfDevNum);
