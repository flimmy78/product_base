...
/*
    ...
    1.1. Call function with non-NULL cntrCfgPtr 
    [{CPSS_BRG_SECUR_BREACH_DROP_COUNT_VLAN_E; port = PRV_CPSS_MAX_PP_PORTS_NUM_CNS 
    ...
    port = PRV_CPSS_MAX_PP_PORTS_NUM_CNS; vlan = 100}]. 
    Expected: NON GT_OK.
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* 1.4. Call function with cntrCfgPtr [{CPSS_BRG_SECUR_BREACH_DROP_COUNT_PORT_E; 
        port = PRV_CPSS_MAX_PP_PORTS_NUM_CNS; vlan = 100}]. Expected: NON GT_OK. */
        cntrCfg.dropCntMode = CPSS_BRG_SECUR_BREACH_DROP_COUNT_PORT_E;
        cntrCfg.port = PRV_CPSS_MAX_PP_PORTS_NUM_CNS;
        cntrCfg.vlan = 100;
