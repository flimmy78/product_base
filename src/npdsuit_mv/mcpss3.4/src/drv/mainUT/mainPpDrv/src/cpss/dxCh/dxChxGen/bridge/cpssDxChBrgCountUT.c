...
*
* DESCRIPTION:
*       Unit tests for cpssDxChBrgCountUT, that provides
        ...
        */
        ...
        if (CPSS_PP_FAMILY_CHEETAH_E == devFamily)
        {
            UTF_VERIFY_NOT_EQUAL2_STRING_MAC(GT_OK, st,
                                         "Cheetah device: %d, %d", dev, dropMode);
        }
        else
        {
...
/*
    ...
    1.3. Call with cntrSetId [CPSS_DXCH_BRG_CNT_SET_ID_0_E],
         ...
         port [PRV_CPSS_MAX_PP_PORTS_NUM_CNS] (should be ignored),
    ...
    1.5. Call with cntrSetId [CPSS_DXCH_BRG_CNT_SET_ID_1_E],  
         ...
         port [PRV_CPSS_MAX_PP_PORTS_NUM_CNS] (should be ignored), vlan [100]. 
    Expected: GT_OK.
    1.6. Call with cntrSetId [CPSS_DXCH_BRG_CNT_SET_ID_0_E], 
         setMode [CPSS_BRG_CNT_MODE_1_E / CPSS_BRG_CNT_MODE_3_E], 
         port [PRV_CPSS_MAX_PP_PORTS_NUM_CNS] (incorrect), vlan [100]. 
    Expected: GT_BAD_PARAM.
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        /* 
           1.3. Call with cntrSetId [CPSS_DXCH_BRG_CNT_SET_ID_0_E],
           setMode [CPSS_BRG_CNT_MODE_0_E], port [PRV_CPSS_MAX_PP_PORTS_NUM_CNS]
        ...
        */
        ...
        /*
           1.5. Call with cntrSetId [CPSS_DXCH_BRG_CNT_SET_ID_1_E],
           setMode [CPSS_BRG_CNT_MODE_2_E], port [PRV_CPSS_MAX_PP_PORTS_NUM_CNS]
        ...
        */
        ...
        /* 
           ...
           [PRV_CPSS_MAX_PP_PORTS_NUM_CNS] (incorrect), vlan [100]. 
           Expected: non GT_OK.
        */
...
/*
    ...
    Expected: GT_OK and same value as written.
    1.3. Call function with dropCnt [0x10000]. 
    Expected: non GT_OK.
*/
    GT_STATUS               st = GT_OK;
    GT_U8                   dev;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChBrgCntDropCntrSet(dev, dropCnt);
        UTF_VERIFY_NOT_EQUAL2_PARAM_MAC(GT_OK, st, dev, dropCnt);
    }
...
/*
    ...
    Expected: GT_OK and same value as written.
    1.1.3. Call function with dropCnt [0x10000]. 
    Expected: non GT_OK.
*/
    GT_STATUS            st = GT_OK;
    GT_U8                dev;
