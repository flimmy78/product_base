...
*
* DESCRIPTION:
*       Unit tests for cpssDxChIpFix, that provides
...
/*******************************************************************************
* prvUtfCompareIpfixEntries
*
* DESCRIPTION:
*       The function compares between configurable fields of IPFIX entries
*
* APPLICABLE DEVICES: DxChXcat and above.
*
* INPUTS:
*       ipfixEntry1Ptr   - pointer to the first IPFIX Entry.
*       ipfixEntry2Ptr   - pointer to the second IPFIX Entry.
*
* OUTPUTS:
*       None.
*
* RETURNS:
*       GT_TRUE     - entries are the same.
*       GT_FALSE    - entries are different.
*
* COMMENTS:
*
*******************************************************************************/
...
/* the maximal number of IPFIX entries is 2K 
   it means 2K/32 words */
#define  IPFIX_BMP_SIZE_CNS (sizeof(GT_U32) * (2048/32))
