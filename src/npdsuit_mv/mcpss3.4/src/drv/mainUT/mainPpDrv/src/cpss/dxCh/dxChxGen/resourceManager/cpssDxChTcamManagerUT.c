...
/*
    ...
    5. Call with wrong value range.firstLine [0xFFFF + 1] (out of range).
    Expected: NOT GT_OK.
    6. Call with wrong value range.lastLine [0xFFFF + 1] (out of range).
    Expected: NOT GT_OK.
...
/*
    ...
    21. Call with reservationType = CPSS_DXCH_TCAM_MANAGER_STATIC_ENTRIES_RESERVATION_E,
        and reservationRange.lastLine  = 0xFFFF + 1 (out of range).
    Expected: NOT GT_OK.
    22. Call with reservationType = CPSS_DXCH_TCAM_MANAGER_DYNAMIC_ENTRIES_RESERVATION_E,
        and reservationRange.lastLine  = 0xFFFF + 1 (not relevant for dynamic).
    Expected: GT_OK.
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        reservationType = CPSS_DXCH_TCAM_MANAGER_STATIC_ENTRIES_RESERVATION_E;
        reservationRange.lastLine  = 0xFFFF + 1;
        ...
        */
        ...
        st = cpssDxChTcamManagerEntriesReservationSet(tcamManagerHandlerPtr, clientId,
                reservationType, requestedEntriesArray, sizeOfArray, &reservationRange);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PARAM, st, clientId, sizeOfArray);

        /*
            25. Call with wrong tcamManagerHandlerPtr[NULL].
            Expected: GT_BAD_PTR.
        */
        st = cpssDxChTcamManagerEntriesReservationSet(NULL, clientId,
                reservationType, requestedEntriesArray, sizeOfArray, &reservationRange);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_BAD_PTR, st, "%d, tcamManagerHandlerPtr = NULL");
        ...
        /*
            ...
            Expected: NOT GT_OK.
        */
        st = cpssDxChTcamManagerEntriesReservationSet(tcamManagerHandlerPtr,
                                                      ((clientId != 0) ? 0 : 1),
                reservationType, requestedEntriesArray, sizeOfArray, &reservationRange);
        UTF_VERIFY_NOT_EQUAL2_PARAM_MAC(GT_OK, st, clientId, sizeOfArray);
...
/*
    ...
    Expected: GT_BAD_PTR.
    7. Call with wrong requestedEntriesArray size[3].
    Expected: NOT GT_OK.
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        UTF_VERIFY_NOT_EQUAL0_STRING_MAC(GT_OK, st, "%d, wrong requestedEntriesArray");
...
/*******************************************************************************
* prvCreateDefaultTcamManager
*
* DESCRIPTION:
*       Creates dafault TCAM manager and returns handler for the created TCAM manager.
*
* INPUTS:
*        None
*
* OUTPUTS:
*       tcamManagerPtrPtr  - points to pointer of the created TCAM manager object
*
* RETURNS:
*       GT_OK                 - on success
...
/*******************************************************************************
* prvCreateDefaultTcamManagerWithClients
*
* DESCRIPTION:
*       Creates dafault TCAM manager and register client.
*
* INPUTS:
*        None
*
* OUTPUTS:
*       clientIdPtr        - points to registered client Id
*       tcamManagerPtrPtr  - points to pointer of the created TCAM manager object
*
* RETURNS:
*       GT_OK                 - on success
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssDxChTcamManager)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChTcamManagerUsageGet)
