...
*
* DESCRIPTION:
*       Unit tests for cpssDxChBrgSrcId, that provides
...
/*
    ...
    1.1. Call function with sourceId [0 / BRG_SRC_ID_MAX_CNS - 1].
    Expected: GT_OK.
    1.2. Call function with sourceId [BRG_SRC_ID_MAX_CNS].
    Expected: NON GT_OK.
*/
    GT_STATUS       st = GT_OK;
    GT_U8           dev;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        {
            /* 1.1. Call function with sourceId [0/BRG_SRC_ID_MAX_CNS - 1]. Expected: GT_OK. */
            sourceId = 0;
            st = cpssDxChBrgSrcIdGroupPortAdd(dev, sourceId, port);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, dev, sourceId, port);

            sourceId = BRG_SRC_ID_MAX_CNS - 1;
            st = cpssDxChBrgSrcIdGroupPortAdd(dev, sourceId, port);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, dev, sourceId, port);

            /* 1.2. Call function with sourceId [BRG_SRC_ID_MAX_CNS]. Expected: NON GT_OK. */
            sourceId = BRG_SRC_ID_MAX_CNS;
...
/*
    ...
    1.3. Call function with sourceId [BRG_SRC_ID_MAX_CNS],
...
/*
    ...
    1.3. Call function with defaultSrcId [BRG_SRC_ID_MAX_CNS] .
    Expected: NON GT_OK.
*/
    GT_STATUS               st = GT_OK;
    GT_U8                   dev;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        {
            /*
                1.1. Call function with defaultSrcId [0 / BRG_SRC_ID_MAX_CNS - 1].
                Expected: GT_OK.
            */
            defaultSrcId = 0;
            ...
            */
            ...
            /*
                ...
                Expected: GT_OK.
            */
            defaultSrcId = BRG_SRC_ID_MAX_CNS - 1;
            ...
            */
            ...
            /*
                ...
                Expected: NON GT_OK.
            */
            defaultSrcId = BRG_SRC_ID_MAX_CNS;
...
*/
    ...
    /* prepare device iterator */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_CH1_E | UTF_CH1_DIAMOND_E | UTF_XCAT_E | UTF_LION_E | UTF_XCAT2_E);
...
*/
    ...
    cpssOsBzero((GT_VOID*) &retPortsMembers, sizeof(retPortsMembers));
