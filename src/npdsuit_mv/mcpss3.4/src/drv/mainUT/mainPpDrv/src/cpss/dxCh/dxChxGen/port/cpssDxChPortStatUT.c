...
*
* DESCRIPTION:
*       Unit tests for cpssDxChPortStat, that provides
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        while(GT_OK == prvUtfNextPhyPortGet(&port, GT_TRUE))
        {
            ...
            {
                if (PRV_CPSS_DXCH_XCAT2_STACK_MAC_COUNT_NO_CLEAR_ON_READ_WA_MAC(dev, port))
                {
...
*/
    ...
    GT_U8                           portGet       = PORT_STAT_VALID_PHY_PORT_CNS;
    GT_U16                          vlanIdGet     = 0;
    GT_U8                           tcGet         = 0;
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        st = cpssDxChPortMacOversizedPacketsCounterModeGet(dev, port, &counterMode);
        UTF_VERIFY_EQUAL3_PARAM_MAC(GT_BAD_PARAM, st, dev, port, counterMode);
    }
