...
*
* DESCRIPTION:
*       Unit tests for cpssBuffManagerPool, that provides
...
*/
    ...
    */
    ...
    UTF_VERIFY_NOT_EQUAL1_PARAM_MAC((GT_U32) NULL, (GT_U32) pBuf, pPoolId);
...
*/
    ...
    */
    ...
    UTF_VERIFY_NOT_EQUAL0_STRING_MAC((GT_U32) NULL, (GT_U32) pBuf1, "cpssBmPoolBufGet");

    pBuf2 = cpssBmPoolBufGet(pPoolId);
    UTF_VERIFY_NOT_EQUAL0_STRING_MAC((GT_U32) NULL, (GT_U32) pBuf2, "cpssBmPoolBufGet");
