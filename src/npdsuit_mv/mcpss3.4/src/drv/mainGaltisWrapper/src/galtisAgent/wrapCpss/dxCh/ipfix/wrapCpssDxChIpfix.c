...
)
{
    ...
    upload.timer.nanoSecondTimer = inArgs[3];
    upload.timer.secondTimer.l[0] = inArgs[4];
    upload.timer.secondTimer.l[1] = inArgs[5];
...
)
{
    ...
    conf.dropThreshold = inArgs[3];
    conf.packetThreshold = inArgs[4];
    conf.byteThreshold.l[0] = inArgs[5];
    conf.byteThreshold.l[1] = inArgs[6];
...
)
{
    ...
    devNum = (GT_U8)inArgs[0];
    stage  = (CPSS_DXCH_POLICER_STAGE_TYPE_ENT)inArgs[1];
    currentIndex = startIndex = inArgs[2];
    endIndex = inArgs[3];
...
)
{
    ...
    devNum = (GT_U8)inArgs[0];
    stage  = (CPSS_DXCH_POLICER_STAGE_TYPE_ENT)inArgs[1];
    entryIndex = inFields[0];
    ipfixEntry.timeStamp = inFields[1];
    ipfixEntry.packetCount = inFields[2];
    ipfixEntry.byteCount.l[0] = inFields[3];
    ipfixEntry.byteCount.l[1] = inFields[4];
    ipfixEntry.dropCounter = inFields[5];
    ipfixEntry.randomOffset = inFields[6];
    ipfixEntry.lastSampledValue.l[0] = inFields[7];
    ipfixEntry.lastSampledValue.l[1] = inFields[8];
    ipfixEntry.samplingWindow.l[0] = inFields[9];
    ipfixEntry.samplingWindow.l[1] = inFields[10];
    ipfixEntry.samplingAction = (CPSS_DXCH_IPFIX_SAMPLING_ACTION_ENT)inFields[11];
    ipfixEntry.logSamplingRange = inFields[12];
    ...
    ipfixEntry.cpuSubCode = inFields[15];
