...
*
* DESCRIPTION:
*       This functioninform cpss about HSU state
*
...
)
{
    ...
    hsuInfo.hsuState = (CPSS_HSU_STATE_ENT)inArgs[0];
    /* call cpss api function */
    result = cpssHsuStateSet(&hsuInfo);

    /* pack output arguments to galtis string */
    galtisOutput(outArgs, result, "%d", hsuInfo.hsuState);
