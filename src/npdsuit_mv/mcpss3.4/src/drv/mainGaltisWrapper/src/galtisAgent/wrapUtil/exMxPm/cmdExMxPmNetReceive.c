...
********************************************************************************
* cmdExMxPmNetReceive.c
*
* DESCRIPTION:
*       galtis agent interface for packet capture using networkIf -- EXMXPM
*
...
)
{
    ...
    cmdOsMemCpy(dstSpecificDeviceFormatPtr,
             ...
             sizeof(CPSS_EXMXPM_NET_RX_PARAMS_STC));

    return;
}

/*******************************************************************************
* cmdExMxPmRxPktReceive
*
* DESCRIPTION:
*       This function returns packets from PP destined to the CPU port.
*        -- SDMA relate.
*
* APPLICABLE DEVICES: ALL PCI/SDMA EXMXPM Devices
*
* INPUTS:
...
{
    GT_STATUS rc;
    CPSS_EXMXPM_NET_RX_PARAMS_STC *tmpRxParamPtr;
    ...
    tmpRxParamPtr = cmdOsMalloc(sizeof(CPSS_EXMXPM_NET_RX_PARAMS_STC));
