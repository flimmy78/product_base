 ...
 )
{
    ...
    dev = (GT_U8)inArgs[0];
    fineTuningPtr = &PRV_CPSS_DXCH_PP_MAC(dev)->fineTuning;
    ...
    {
        numOfLttRows = fineTuningPtr->tableSize.routerAndTunnelTermTcam;
...
*       GT_OUT_OF_RANGE - lttTTIndex is bigger then range.
*       GT_BAD_PTR      - one of the parameters is NULL pointer
*
* COMMENTS:
 ...
 )
{
    ...
    minRowLtt    = inArgs[1];
    maxRowLtt    = inArgs[2];
    minColumnLtt = inArgs[3];
    maxColumnLtt = inArgs[4];
 ...
 )
{
    ...
    {
        numOfTcamRows = fineTuningPtr->tableSize.routerAndTunnelTermTcam;
...
* INPUTS:
*       devNum               - the device number
*       baseRouteEntryIndex  - the base Index in the Route entries table range
*                              (0..4095). The entries will be written from this
*                              base on.
...
*       GT_OK           - on success.
*       GT_BAD_PARAM    - on devNum not active.
*       GT_OUT_OF_RANGE - on baseRouteEntryIndex bigger then 4095 or
 ...
 )
{
    ...
    regularEntry->nextHopInterface.devPort.devNum = (GT_U8)inFields[23];
    regularEntry->nextHopInterface.devPort.portNum = (GT_U8)inFields[24];
    CONVERT_DEV_PORT_DATA_MAC(regularEntry->nextHopInterface.devPort.devNum,
 ...
 *       GT_OK          - on success
 *       GT_BAD_PARAM   - on devNum not active.
 *       GT_OUT_OF_RANGE - on baseRouteEntryIndex bigger then 4095.
 *       GT_BAD_PTR     - one of the parameters is NULL pointer
 *
 * COMMENTS:
 *
 ...
 *******************************************************************************/
     ...
     )
 {
     ...
     CONVERT_BACK_DEV_PORT_DATA_MAC(regularEntry->nextHopInterface.devPort.devNum,
         regularEntry->nextHopInterface.devPort.portNum);
     inFields[23] = regularEntry->nextHopInterface.devPort.devNum;
 ...
 )
{
    ...
    routeEntriesArray[cIndexSet].entry.regularEntry.nextHopInterface.devPort.devNum = (GT_U8)inFields[23];
    routeEntriesArray[cIndexSet].entry.regularEntry.nextHopInterface.devPort.portNum = (GT_U8)inFields[24];
    CONVERT_DEV_PORT_DATA_MAC(routeEntriesArray[cIndexSet].entry.regularEntry.nextHopInterface.devPort.devNum ,
 ...
 )
{
   ...
   if(inArgs[4]==CPSS_DXCH_IP_UC_ROUTE_ENTRY_E)
      ...
      return wrCpssDxChIpUcRouteEntriesSet_CPSS_DXCH_IP_UC_ROUTE(inArgs,inFields,numFields,outArgs);
...
*******************************************************************************/
  ...
  )
 {
     ...
     tempDevNum=routeEntriesArray[cIndexGet].entry.regularEntry.nextHopInterface.devPort.devNum  ;
 ...
 )
{
    ...
    if(routeEntriesArray[cIndexGet].type==CPSS_DXCH_IP_UC_ROUTE_ENTRY_E)
        result=wrCpssDxChIpUcRouteEntriesGet_CPSS_DXCH_IP_UC_ROUTE(inArgs,inFields,numFields,outArgs);
    else
...
* INPUTS:
*       devNum          - the device number
*       RouteEntryIndex - the Index in the Route entries table range
*                         (0..4095).
 ...
 )
{
    ...
    if((numToRefresh == 0)||
       (baseRouteEntryIndex > 4095) ||
       ((baseRouteEntryIndex + numToRefresh)>4095))
    {
        galtisOutput(outArgs,GT_OK, "illegal number of entries to refresh %d", -1);
        return CMD_OK;
    }
 ...
 )
{
    ...
    if((gRouteEntryIndex > 4095) || (gNumToRefresh == 0))
    {
        galtisOutput(outArgs, GT_OK, "%d", -1);
        return CMD_OK;
    }
 ...
 )
{
    ...
    gRouterNextHopTableAgeBitsEntry |= (activityBit << bitOffset);
 ...
 )
{
    ...
    mllPairWriteForm = (CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_FORM_ENT)inFields[1];
        ...
        mllPairWriteForm == CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_FIRST_MLL_ONLY_E)
    {
        ...
        mllPairEntry.firstMllNode.nextHopInterface.devPort.devNum = (GT_U8)inFields[6];
        mllPairEntry.firstMllNode.nextHopInterface.devPort.portNum = (GT_U8)inFields[7];
        CONVERT_DEV_PORT_DATA_MAC(mllPairEntry.firstMllNode.nextHopInterface.devPort.devNum,
        ...
        CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_SECOND_MLL_NEXT_POINTER_ONLY_E)
    {
        ...
        mllPairEntry.secondMllNode.nextHopInterface.devPort.devNum = (GT_U8)inFields[19];
        mllPairEntry.secondMllNode.nextHopInterface.devPort.portNum = (GT_U8)inFields[20];
        CONVERT_DEV_PORT_DATA_MAC(mllPairEntry.secondMllNode.nextHopInterface.devPort.devNum,
 ...
 )
{
    ...
    result = cpssDxChIpMLLPairRead(devNum, gMllPairEntryIndex,
                                   CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_WHOLE_E, &mllPairEntry);
    ...
    CONVERT_BACK_DEV_PORT_DATA_MAC(mllPairEntry.firstMllNode.nextHopInterface.devPort.devNum,
        mllPairEntry.firstMllNode.nextHopInterface.devPort.portNum);
    inFields[6] = mllPairEntry.firstMllNode.nextHopInterface.devPort.devNum;
    ...
    CONVERT_BACK_DEV_PORT_DATA_MAC(mllPairEntry.secondMllNode.nextHopInterface.devPort.devNum,
        mllPairEntry.secondMllNode.nextHopInterface.devPort.portNum);
    inFields[19] = mllPairEntry.secondMllNode.nextHopInterface.devPort.devNum;
 ...
 )
{
    ...
    GT_U32                                       rangeEnd;
    CPSS_DXCH_IP_MLL_PAIR_STC                    mllPairEntry;
    CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_FORM_ENT    mllPairReadForm;
    ...
    {
        mllPairReadForm = (CPSS_DXCH_IP_MLL_PAIR_READ_WRITE_FORM_ENT)inArgs[3];
    }
    else
    {
