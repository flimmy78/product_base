...
)
{
    ...
    GT_U32  *currPtr;
    GT_U32  sizes[] = {
                sizeof(cmdExtDrvFuncBindInfo) / sizeof(GT_U32),
                sizeof(cmdOsFuncBind        ) / sizeof(GT_U32),
                sizeof(cmdOsExtraFuncBind   ) / sizeof(GT_U32),
                sizeof(cmdExtraFuncBind     ) / sizeof(GT_U32),
                0};
    GT_U32  *ptrArray[]={
    ...
    do
    {
        ...
        {
            if((*currPtr) == (GT_U32)((void*)extServiceFuncNotImplementedCalled))
            {
...
{
    if(GT_OK != applicationExtServicesBind(&cmdExtDrvFuncBindInfo,&cmdOsFuncBind,&cmdOsExtraFuncBind,&cmdExtraFuncBind))
    {
        return GT_FAIL;
    }
