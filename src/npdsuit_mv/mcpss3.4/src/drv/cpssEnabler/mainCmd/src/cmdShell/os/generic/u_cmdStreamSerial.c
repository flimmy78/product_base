...
static int serialStreamDestroy(cmdStreamPTR streamP)
{
...
static int serialStreamRead(cmdStreamPTR streamP, void* bufferPtr, int bufferLength)
{
    serialStreamPTR stream = (serialStreamPTR)streamP;
...
static int serialStreamReadChar(cmdStreamPTR streamP, char* charPtr, int timeOut)
{
    serialStreamPTR stream = (serialStreamPTR)streamP;
    fd_set rfds;
    int k;
...
static int serialStreamReadLine(cmdStreamPTR streamP, char* bufferPtr, int bufferLength)
{
    serialStreamPTR stream = (serialStreamPTR)streamP;
    int k;
...
#endif
static int serialStreamWrite(cmdStreamPTR streamP, const void* bufferPtr, int bufferLength)
{
    serialStreamPTR stream = (serialStreamPTR)streamP;
...
static int serialStreamConnected(cmdStreamPTR streamP)
{
    serialStreamPTR stream = (serialStreamPTR)streamP;
...
static int serialGrabStd(cmdStreamPTR streamP)
{
    serialStreamPTR stream = (serialStreamPTR)streamP;
...
static int serialSetTtyMode(cmdStreamPTR streamP, int mode)
{
    serialStreamPTR stream = (serialStreamPTR)streamP;
...
static int serialGetFd(cmdStreamPTR streamP)
{
    serialStreamPTR stream = (serialStreamPTR)streamP;
...
)
{
    ...
    stream->fd = fd;
    /* force lineedit mode */
    serialSetTtyMode((cmdStreamPTR)stream, 1);
