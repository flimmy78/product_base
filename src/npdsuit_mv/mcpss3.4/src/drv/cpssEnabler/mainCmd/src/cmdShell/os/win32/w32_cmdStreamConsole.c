...
static int consoleStreamDestroy(cmdStreamPTR streamP)
{
...
static int consoleStreamRead(cmdStreamPTR streamP, void* bufferPtr, int bufferLength)
{
    consoleStreamPTR stream = (consoleStreamPTR)streamP;
    DWORD status, bytes;
...
static int consoleStreamReadChar(cmdStreamPTR streamP, void* charPtr, int timeOut)
{
    consoleStreamPTR stream = (consoleStreamPTR)streamP;
    DWORD status, bytes;
...
static int consoleStreamReadLine(cmdStreamPTR streamP, char* bufferPtr, int bufferLength)
{
    consoleStreamPTR stream = (consoleStreamPTR)streamP;
    DWORD status, bytes;
...
static int consoleStreamWrite(cmdStreamPTR streamP, const void* bufferPtr, int bufferLength)
{
    consoleStreamPTR stream = (consoleStreamPTR)streamP;
...
static int consoleStreamConnected(cmdStreamPTR streamP)
{
    consoleStreamPTR stream = (consoleStreamPTR)streamP;
...
static int consoleGrabStd(cmdStreamPTR streamP)
{
    consoleStreamPTR stream = (consoleStreamPTR)streamP;
...
static int consoleSetTtyMode(cmdStreamPTR streamP, int mode)
{
    consoleStreamPTR stream = (consoleStreamPTR)streamP;
...
cmdStreamPTR cmdStreamCreateWin32Console(void)
{
    ...
    /* force lineedit mode */
    consoleSetTtyMode((cmdStreamPTR)stream, 1);
