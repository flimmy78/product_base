...
/* zhangdi change BUFF_LEN 20 to 5, make it the same to nam_rx.h */
#ifndef BUFF_LEN  /* It is true here defined!!! */
//#define BUFF_LEN    20
#define BUFF_LEN    5
#endif
...
extern GT_STATUS appDemoPacketRxAdapterTask
(
	GT_VOID
);

#ifdef __AX_PLATFORM__
extern long taskDelay
( 
		long interval
);
#endif
