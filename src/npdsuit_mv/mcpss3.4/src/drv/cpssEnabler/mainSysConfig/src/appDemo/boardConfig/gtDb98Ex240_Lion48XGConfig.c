...
)
{
    ...
    if(appDemoPpConfigList[devIdx].devFamily == CPSS_PP_FAMILY_PUMA_E) /* Puma device */
    {
...
)
{
    ...
    if(appDemoPpConfigList[oldDevNum].devFamily == CPSS_PP_FAMILY_PUMA_E)
    {
        /* Puma device */
...
)
{
    ...
    for(dev = 0; dev < PRV_CPSS_MAX_PP_DEVICES_CNS; dev++)
    {
            ...
            (appDemoPpConfigList[dev].devFamily == CPSS_PP_FAMILY_DXCH_LION_E))
        {
            ...
            (appDemoPpConfigList[dev].devFamily == CPSS_PP_FAMILY_PUMA_E))
        {
...
)
{
    ...
    if(appDemoPpConfigList[devNum].devFamily == CPSS_PP_FAMILY_PUMA_E) /* Puma device */
    {
        /* Puma devices */
