...
)
{
    ...
    extDrvDirectSmiWriteReg(0x14, 20, (0x0C82 | (macIfSpeed << 4)));
...
{
    CPSS_PORT_SPEED_ENT      speedCurr;
    CPSS_PORT_SPEED_ENT      speedHistory;
    MEDIA_TYPE_ENT      mediaCurr;
    ...
    while (1)
    {
        ...
        if (COPPER_E == mediaCurr)
        {
            ...
            speedCurr = (CPSS_PORT_SPEED_ENT)((regVal >> 14) & 0x3);
