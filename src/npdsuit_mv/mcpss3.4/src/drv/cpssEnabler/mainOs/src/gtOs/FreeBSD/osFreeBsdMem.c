...
)
{
    ...
    if (firstInitialization == GT_TRUE)
    {
        magicPtr = (GT_U32*)SHARED_MALLOC_MAC(size+sizeof(GT_U32));
        if (magicPtr == NULL)
        {
            return NULL;
        }
...
)
{
    ...
    {
        GT_U32 *magicPtr =
            realloc((void*)(((GT_U32)ptr)-sizeof(GT_U32)), size+sizeof(GT_U32));
        if (magicPtr == NULL)
        {
            return NULL;
        }
...
)
{
    ...
    if (firstInitialization == GT_TRUE)
    {
        ...
        SHARED_FREE_MAC(memblock-sizeof(GT_U32));
#endif
    }
    else
    {
        magicPtr = memblock-sizeof(GT_U32);
