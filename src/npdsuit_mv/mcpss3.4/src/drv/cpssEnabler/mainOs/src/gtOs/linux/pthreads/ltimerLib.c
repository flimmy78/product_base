...
#if (defined ASIC_SIMULATION) && (defined EXMXPM_FAMILY) && (defined FREEBSD)
...
)
{
    ...
    */
	...
	/* here we could use CLOCK_MONOTONIC read startup time, as /proc/uptiem, to avoid read from RTC. zhagndi */
    ...
    */
    ...
    {
		/* add to avoid long long sleep, zhangdi@autelan.com 2012-10-7 */
		if(delta.tv_sec>5)
		{
			break;
		}		
