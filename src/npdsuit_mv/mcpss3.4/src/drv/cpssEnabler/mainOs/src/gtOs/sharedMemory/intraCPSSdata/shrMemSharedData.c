...
GT_U32 baseAddr = 0;
GT_U32 dmaSize = 2 * (1024 * 1024); /* default */

/* Share wrapper init flag: only the first client should init wrappers! */
GT_BOOL gtOsWrapperOpen = GT_FALSE;

#ifdef ASIC_SIMULATION /* Applicable only for WM */
/* Internal mutex for osSetIntLockUnlock routine.
 * All clients should share the same mutex. */
int IntLockmutex = 0;
#endif
