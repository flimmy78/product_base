        ...
        for (auIndex = 0; auIndex < numOfAu; auIndex++)
        {
            switch (bufferArr[auIndex].updType)
            {
                ...
                case CPSS_TA_E:
                {
                    ...
                    /* write data to cpss */
		/*
                       rc = cpssDxChBrgFdbMacEntrySet(dev, &cpssMacEntry);
		*/
						rc = cpssEnFdbBrgFdbEntrySetFunc(dev, &cpssMacEntry);
...
/*
						   rc = cpssDxChBrgFdbFromCpuAuMsgStatusGet(dev,
                                                                    &completed,
                                                                    &succeeded);
*/
