...
typedef struct
{
	unsigned char appendType; /*1(time)1(outQos)1(inQos)1(redirect)1(mirror)1(deny)1(permit)1(trap)*/
...
#ifdef DRV_LIB_CPSS
extern unsigned long cpssDxChPclRuleSet
(
	 unsigned char                      devNum,
...
extern unsigned long cpssDxChPclIngressPolicyEnable
(
	unsigned char   devNum,
	unsigned char 	enable
);

extern unsigned long cpssDxCh2PclEgressPolicyEnable
(
	unsigned char   devNum,
	unsigned char 	enable
);
...
extern unsigned long  cpssDxChPclPortIngressPolicyEnable
(
    unsigned char    devNum,
    unsigned char    port,
    unsigned char    enable
...
extern unsigned long cpssDxChPclCfgTblSet
(
     unsigned char                   devNum,
...
extern unsigned long cpssDxChPclPortLookupCfgTabAccessModeSet
(
     unsigned char                                  devNum,
     unsigned char                                  port,
     CPSS_PCL_DIRECTION_ENT                         direction,
...
extern unsigned long prvCpssDrvHwPpReadRegister
(
		unsigned char                           devNum,
		unsigned long 							regAddr, 
		unsigned long						    *gloRegData
);
extern unsigned long cpssDxChPclCfgTblGet
(
     unsigned char                   devNum,
     CPSS_INTERFACE_INFO_STC        *interfaceInfoPtr,
     CPSS_PCL_DIRECTION_ENT          direction,
...
extern unsigned long cpssDxChPclCfgTblAccessModeGet
(
    unsigned char                            devNum,
    CPSS_DXCH_PCL_CFG_TBL_ACCESS_MODE_STC   *accModePtr
);
extern unsigned long cpssDxChPclRuleGet
(
      unsigned char                   devNum,
...
extern unsigned long prvCpssDxChReadTableEntry
(
     unsigned char                  devNum,
     PRV_CPSS_DXCH_TABLE_ENT 		tableType,
     unsigned int                   entryIndex,
     unsigned int           		*entryValuePtr
);

extern unsigned long cpssDxCh2EgressPclPacketTypesSet
(
   unsigned char                             devNum,
    unsigned char                            port,
...
unsigned long cpssDxChMirrorRxAnalyzerPortGet
(
    unsigned char   dev,
...
extern unsigned long cpssDxChPclIngressPolicyEnableGet
(
   unsigned char   devNum,
    unsigned long *enable
);

extern unsigned long cpssDxChPclRuleActionUpdate
(
    unsigned char                      devNum,
    CPSS_PCL_RULE_SIZE_ENT             ruleSize,
...
extern unsigned long cpssDxChPclRuleActionGet
(
    unsigned char                      devNum,
    CPSS_PCL_RULE_SIZE_ENT             ruleSize,
    unsigned int                       ruleIndex,
...
extern unsigned long cpssDxChPclRuleInvalidate
(
    unsigned char                              devNum,
    CPSS_PCL_RULE_SIZE_ENT             ruleSize,
    unsigned int                            ruleIndex
...
#endif
#endif
unsigned int nam_acl_service_get(unsigned int *enable);
