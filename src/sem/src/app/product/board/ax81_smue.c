...
int miisw_read(unsigned int devaddr, unsigned int regaddr,unsigned int phyaddr)
{
...
int miisw_write(unsigned int devaddr, unsigned int regaddr, unsigned short value,unsigned int phyaddr)
{
	smi_cmd_88e6185_reg_t smi_cmd;
...
int ax81_smue_init(void)
{
	...
	{
		miisw_write(port, MV_88E6185_PORT_BASED_VLAN_MAP, data,phyaddr1);
		miisw_write(port, MV_88E6185_PSC_CONCTRL_REG, data2,phyaddr1);
	}

	data = 0x1ff;
	miisw_write(0x19, MV_88E6185_PORT_BASED_VLAN_MAP, data,phyaddr1);
	miisw_write(0x19, MV_88E6185_PSC_CONCTRL_REG, data2,phyaddr1);
...
static int ax81_smue_show_system_environment(env_state_t *env_state)
{
	int i, ret = 0;
	int fd;
	int reg_data = 0;
...
board_fix_param_t ax81_smue =
{
	.board_code = AX81_CRSMUE_BOARD_CODE,
	.board_type = BOARD_TYPE_AX81_SMUE,
	.board_id = BOARD_SOFT_ID_AX81_SMUE,
	.name = "AX81_SMUE",
	.slot_id = UNKONWN_SLOT_ID,
	.is_master = IS_MASTER,
	.cpu_num = SINGLE_CPU,
	.port_num_on_panel = 2,
	.port_arr = {{CPU, ETH_GTX, 0, 0, 2, AX81_CRSMUE_ETHPORT_DEFAULT_ATTR}, 
            	 {CPU, ETH_GTX, 1, 1, 1, AX81_CRSMUE_ETHPORT_DEFAULT_ATTR}},
	...
	.board_ap_max_counter = AX81_CRSMUE_AP_MAX,
	...
	.hard_self_reset = ax81_smue_hard_reset,
	.board_self_init = ax81_smue_init,
	...
	.show_system_environment = ax81_smue_show_system_environment
};
