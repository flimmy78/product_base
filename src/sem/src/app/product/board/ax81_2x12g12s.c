...
static int local_board_dbm_file_create(board_fix_param_t *board)
{
	...
	#else
	board->board_ap_max_counter = (__AP_MAX_COUNTER > AX81_2X12G12S_AP_MAX) ? AX81_2X12G12S_AP_MAX: __AP_MAX_COUNTER;
	fprintf(fd, "%d\n", board->board_ap_max_counter);
...
int ax81_2x12g12s_hard_reset(void)
{
	int ret;
...
static int ax81_2x12g12s_show_system_environment(env_state_t *env_state)
{
	...
	if ((get_num_from_file(MASTER_TEMP1_INPUT, &master_temp1_input) >= 0)
		...
		sem_syslog_dbg("ax81_2x12g12s read cpu temperature error! \n");
		return -1;	
	}
...
board_fix_param_t ax81_2x12g12s =
{
	.board_code = AX81_2X12G12S_BOARD_CODE,
	.board_type = BOARD_TYPE_AX81_2X12G12S,
	.board_id = BOARD_SOFT_ID_AX81_2X12G12S,
	.name = "AX81_2X12G12S",
	...
	.hard_self_reset = ax81_2x12g12s_hard_reset,
	.board_self_init = ax81_2x12g12s_init,
	.init_local_mac_info = init_local_mac_info,
	.update_local_mac_info = update_local_mac_info,
	.init_local_sn_info = init_local_sn_info,
	.show_system_environment = ax81_2x12g12s_show_system_environment
};
