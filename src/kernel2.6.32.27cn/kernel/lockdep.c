...
void print_irqtrace_events(struct task_struct *curr)
{
	...
	if (kes_mem_print_handle) {
		kes_mem_print_handle("irq event stamp: %u\n", curr->irq_events);
		kes_mem_print_handle("hardirqs last  enabled at (%u): ", curr->hardirq_enable_event);
		kes_mem_print_handle("[<%p>] %pS\n", (void *)(curr->hardirq_enable_ip), (void *)(curr->hardirq_enable_ip));
		kes_mem_print_handle("hardirqs last disabled at (%u): ", curr->hardirq_disable_event);
		kes_mem_print_handle("[<%p>] %pS\n", (void *)(curr->hardirq_disable_ip), (void *)(curr->hardirq_disable_ip));
		kes_mem_print_handle("softirqs last  enabled at (%u): ", curr->softirq_enable_event);
		kes_mem_print_handle("[<%p>] %pS\n", (void *)(curr->softirq_enable_ip), (void *)(curr->softirq_enable_ip));
		kes_mem_print_handle("softirqs last disabled at (%u): ", curr->softirq_disable_event);
