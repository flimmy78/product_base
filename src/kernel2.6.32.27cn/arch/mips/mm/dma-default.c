...
static void mips_dma_sync_single_range_for_cpu(struct device *dev,
...
static void mips_dma_sync_single_range_for_device(struct device *dev,
	dma_addr_t dma_handle, unsigned long offset, size_t size,
	enum dma_data_direction direction)
{
	plat_extra_sync_for_device(dev);
...
int mips_dma_is_consistent(struct device *dev, dma_addr_t dma_addr)
{
	return plat_device_is_coherent(dev);
}
...
static struct mips_dma_map_ops mips_default_dma_map_ops = {
	.dma_map_ops = {
		...
		.sync_single_range_for_cpu = mips_dma_sync_single_range_for_cpu,
		.sync_single_range_for_device = mips_dma_sync_single_range_for_device,
