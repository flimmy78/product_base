...
static struct mips_dma_map_ops octeon_linear_dma_map_ops = {
	.dma_map_ops = {
		...
		.sync_single_range_for_device = octeon_dma_sync_single_range_for_device,
...
void __init plat_swiotlb_setup(void)
{
	...
	if (OCTEON_IS_MODEL(OCTEON_CN31XX)
		 ...
		 */
		/*swiotlbsize = 64 * (1<<20);*/
		/* decreased to 1MB to used as swiotlb and let PCI bar1 small  mode can translate more RAM.
		to see  more at pci-octeon.c line 702.
	...
	swiotlb_init_with_default_size(swiotlbsize);
