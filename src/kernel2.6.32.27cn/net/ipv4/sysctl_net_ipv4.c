...
static struct ctl_table ipv4_table[] = {
	...
	{
		.ctl_name	= NET_IPV4_IPFRAG_INFORM_NHMTU_INSTEAD,
		.procname	= "ipfrag_inform_nhmtu_instead",
		.data		= &sysctl_ipfrag_inform_nhmtu_instead,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	{
		.ctl_name	= NET_IPV4_IPFRAG_INGRESS_PMTU,
		.procname	= "ipfrag_ingress_pmtu",
		.data		= &sysctl_ipfrag_ingress_pmtu,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	{
		.ctl_name	= NET_IPV4_IPFRAG_IGNOREDF,
		.procname	= "ipfrag_ignoredf",
		.data		= &sysctl_ipfrag_ignoredf,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	/* PMTU debug switch mtu added by chenbin@autelan.net */
	{
		.ctl_name	= NET_IPV4FRAG_PMTU_DEBUG,
		.procname	= "ipfrag_pmtu_debug",
		.data		= &sysctl_ipfrag_pmtu_debug,
		.maxlen 	= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
