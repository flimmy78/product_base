...
/****************hanhui upgrade ******************/
HANDLE_IOCTL(SIOCGIFUDFFLAGS, dev_ifsioc)
HANDLE_IOCTL(SIOCSIFUDFFLAGS, dev_ifsioc)
HANDLE_IOCTL(SIOCGGINDEX, dev_ifsioc)
HANDLE_IOCTL(SIOCSGINDEX, dev_ifsioc)
HANDLE_IOCTL(SIOCGIFPRIVFLAGS, dev_ifsioc)
/*********************end***********************/
