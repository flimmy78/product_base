...
/* add for presteraIrq.c:207: error: 'SA_SHIRQ' undeclared, zhangdi@autelan.com */
...
/* Added Marvell interrupt support by qinhs@autelan.com
 */
#define SA_MARVELL_INT	0x00008000  /* marvell irq flag */
/*
