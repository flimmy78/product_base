...
extern int sysctl_ipfrag_ignoredf;
/* Send Frag_Needed with nexthop MTU icmp if only packet len > mtu of next hop, 
no matter whether DF was set, added by chenb@autelan.net */
extern int sysctl_ipfrag_inform_nhmtu_instead;
/* PMTU against ingress dev mtu instead of nexthop mtu added by chenb@autelan.net */
extern int sysctl_ipfrag_ingress_pmtu;
extern int sysctl_ipfrag_pmtu_debug;
