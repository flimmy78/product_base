...
#ifndef __TRUNK_3AD_H__
#define __TRUNK_3AD_H__
...
#define TRUNK_3AD_CHANE_IF_MSG 0x20070528
/* struct ad_bond_msg
 */
struct ad_event
{
	int	bond_ifindex;		/* bond Link index	*/
	int	slave_ifindex;		/* slave Link index	*/
	int	state;				/* 0 for add,1 for delete */
	int	flag;
};
#endif
