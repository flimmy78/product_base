...
CAVIUM_GET_SG_SIZE(octeon_sg_entry_t  *sg_entry,  int pos)
{
#if  __CAVIUM_BYTE_ORDER == __CAVIUM_BIG_ENDIAN
...
typedef struct {
  uint64_t    start;  /**< Range starts at this address. */
...
typedef  struct {
  ...
  uint64_t    range_count;  /**< Number of distinct Core addr ranges to map */
  union {
     oct_range_val_t   *ranges;  /**< Address ranges. */
     uint64_t          u64;
  } u;
} oct_dev_range_t;
...
/* $Id: octeon-common.h 53786 2010-10-08 22:09:32Z panicker $ */
