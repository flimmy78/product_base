...
static inline void
CAVIUM_INIT_LIST_HEAD(cavium_list_t *ptr)
{
...
static inline
cavium_list_t *cavium_list_get_head(cavium_list_t  *root)
{
...
static inline
cavium_list_t *cavium_list_get_tail(cavium_list_t  *root)
{
	if( (root->le_prev == root)  &&  (root->le_next == root) )
		return NULL;
...
static inline 
void cavium_list_del(cavium_list_t *node)
{
...
static inline
cavium_list_t *cavium_list_delete_head(cavium_list_t  *root)
{
...
/* $Id: cavium-list.h 63418 2011-08-11 21:17:53Z panicker $ */
