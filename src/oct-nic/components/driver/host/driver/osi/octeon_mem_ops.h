 ...
 */
void *
octeon_get_mapped_addr(octeon_device_t  *oct,
                       uint64_t          core_addr);
 ...
 */
uint32_t
octeon_read_device_mem32(octeon_device_t   *oct, uint64_t core_addr);
 ...
 */
uint16_t
octeon_read_device_mem16(octeon_device_t   *oct, uint64_t core_addr);
 ...
 */
uint8_t
octeon_read_device_mem8(octeon_device_t   *oct, uint64_t core_addr);
 ...
 *   @param  val64       -  64-bit value to write.
 *
 *   The range_idx gives the BAR1 index register for the range of address
 *   in which core_addr is mapped. 
 *
 ...
 */
int
octeon_write_device_mem64(octeon_device_t   *oct, uint64_t core_addr, uint64_t val);
 ...
 */
int
octeon_write_device_mem32(octeon_device_t   *oct, uint64_t core_addr, uint32_t val);
 ...
 */
int
octeon_write_device_mem16(octeon_device_t   *oct, uint64_t core_addr, uint16_t  val);
 ...
 *   @param  oct         -  pointer to the octeon device.
 *   @param  core_addr   -  the address to write to.
 *   @param  val8        -  8-bit value to write.
 *
 *   @return  Nothing.
 */
int
octeon_write_device_mem8(octeon_device_t   *oct, uint64_t core_addr, uint8_t val);
...
/* $Id: octeon_mem_ops.h 53785 2010-10-08 22:08:08Z panicker $ */
