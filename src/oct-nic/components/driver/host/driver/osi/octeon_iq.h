 ...
 *  @param octeon_iq_conf  - configuration parameters for this input queue. 
 ...
 */
int   octeon_init_instr_queue(octeon_device_t     *octeon_dev,
                              int                  iq_no );
 ...
 *  @return  Success: 0   Failure: 1
 */
int   octeon_delete_instr_queue(octeon_device_t     *octeon_dev,
                                int                  iq_no);
...
/* $Id: octeon_iq.h 67259 2011-11-21 23:36:49Z mchalla $ */
