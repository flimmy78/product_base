 ...
 */
void print_queue(octeon_device_t  *oct_dev,
                 int               iq_no );
 ...
 *   response list.
 */
void print_response_list(octeon_device_t  *octeon_dev,
 ...
 */
void octeon_print_command(OCTEON_IQ_INSTRUCTION_MODE    iq_mode,
                          void                         *arg);
...
#define print_cntq(arg1, arg2 )    do { } while(0);
#define print_ddoq(arg1)           do { } while(0);
#define print_octeon_regs(arg1)    do { } while(0);
...
static inline void
cavium_error_print_data(uint8_t *data, int size)
{
  int i;
...
/* $Id: octeon_debug.h 53785 2010-10-08 22:08:08Z panicker $ */
