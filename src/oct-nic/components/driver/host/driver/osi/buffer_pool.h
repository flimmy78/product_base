...
typedef struct {
  ...
  uint32_t huge_buffer_max;   /**< number in huge 32K buffer pool */
  uint32_t large_buffer_max;  /**< number in large 16K buffer pool */
  uint32_t medium_buffer_max; /**< number in medium 8K buffer pool */
  uint32_t small_buffer_max;  /**< number in small 4K buffer pool */
  uint32_t tiny_buffer_max;   /**< number in tiny 2K buffer pool */
  uint32_t ex_tiny_buffer_max; /**< number in ex tiny 1K buffer pool */
...
/* $Id: buffer_pool.h 42960 2009-05-28 19:45:43Z panicker $ */
