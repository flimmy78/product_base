...
/** Checks the noresponse list associated with one of four instr queues.
  ...
  * @param octeon_dev      - the octeon device structure.
  * @param resp_list       - one of four noresponse lists.
  * @param old_read_index  - octeon read till this index previously.
  * @param new_read_index  - octeon has read till this index now.
  * @param instr_queue     - the instruction queue associated with "resp_list"
  */
void
...
/** Check the status of first entry in the ordered list. If the instruction at
  ...
  */
int process_ordered_list(octeon_device_t *octeon_dev);
...
/* $Id: response_manager.h 53785 2010-10-08 22:08:08Z panicker $ */
