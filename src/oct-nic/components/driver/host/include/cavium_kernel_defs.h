...
/** Register a change in droq operations. The ops field has a pointer to a
  ...
  */ 
int
octeon_register_droq_ops(int octeon_id, int q_no, octeon_droq_ops_t  *ops);
...
/** Resets the function pointer and flag settings made by
  ...
  */
int
octeon_unregister_droq_ops(int octeon_id, int q_no );
 ...
 */
int
octeon_register_poll_fn(int oct_id, octeon_poll_ops_t  *ops);
...
/* $Id: cavium_kernel_defs.h 59212 2011-04-14 18:46:46Z panicker $ */
